...
**Elena is a simple, tiny library (2.4kB) for building [Progressive Web Components](/components/overview).** Unlike most web component libraries, Elena doesn’t force JavaScript for everything. You can load HTML and CSS first, then use JavaScript to progressively add interactivity. [^1]
...
- 🔋 **Extremely lightweight:** 2.4kB minified & compressed, simple and tiny by design.
