...
The “partial support” bit for the latter means that you can visually render them without JavaScript, but JS is needed for the full interactive _(unless you also use the provided [@elenajs/ssr](#rendering-to-html-strings) tool)._
