---
title: MCP server
description: Use @elenajs/mcp to connect Elena Progressive Web Component metadata and scaffolding tools to AI assistants via the Model Context Protocol.
---
...
## Resources <Badge type="warning" text="Experimental" />
...
## Tools <Badge type="warning" text="Experimental" />
...
## Prompts <Badge type="warning" text="Experimental" />
...
## Skills <Badge type="warning" text="Experimental" />
