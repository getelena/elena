const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/Playground.D9d5mgTf.js","assets/chunks/framework.CHRjkDA5.js"])))=>i.map(i=>d[i]);
import{_ as q,o as d,c as p,ae as U,j as l,n as x,F as C,z,t as N,Z as F,v as W,x as J,C as j,k as V,b as B,E as Z,e as _,w as K,T as Y,L as G,p as h,S as A,D as X,h as Q}from"./framework.CHRjkDA5.js";const ee={},te={class:"pg-loading-skeleton"};function se(e,t){return d(),p("div",te,[...t[0]||(t[0]=[U('<div class="pg-editor pg-editor-loading"><div class="pg-editor-tabs"><button class="pg-editor-tab active">HTML</button><button class="pg-editor-tab">CSS</button><button class="pg-editor-tab">JS</button></div><div class="pg-editor-container"></div></div><div class="pg-preview"><div class="pg-preview-header"><span class="pg-preview-title">Preview</span></div><div class="pg-preview-iframe"></div></div>',2)])])}const I=q(ee,[["render",se]]),ne={class:"pg-sidebar-nav"},ie={class:"pg-sidebar-heading"},ae={class:"pg-sidebar-items"},oe={class:"item"},re=["href","onClick"],le={class:"text"},ce={__name:"PlaygroundSidebar",props:{examples:{type:Array,required:!0},currentId:{type:String,default:""},open:{type:Boolean,default:!1}},emits:["select","toggle"],setup(e,{emit:t}){const s=t;return(o,n)=>(d(),p(C,null,[l("div",{class:x(["pg-sidebar-backdrop",{open:e.open}]),onClick:n[0]||(n[0]=r=>s("toggle"))},null,2),l("aside",{class:x(["pg-sidebar",{open:e.open}])},[l("nav",ne,[(d(!0),p(C,null,z(e.examples,r=>(d(),p("div",{key:r.category,class:"pg-sidebar-group"},[l("p",ie,N(r.category),1),l("div",ae,[(d(!0),p(C,null,z(r.items,c=>(d(),p("div",{key:c.id,class:x(["pg-sidebar-item",{"is-active":e.currentId===c.id}])},[l("div",oe,[n[1]||(n[1]=l("div",{class:"indicator"},null,-1)),l("a",{class:"link",href:"#"+c.id,onClick:F(u=>s("select",c.id),["prevent"])},[l("p",le,N(c.title),1)],8,re)])],2))),128))])]))),128))])],2)],64))}},de={id:"hello-world",title:"Hello World",js:`import { Elena, html } from "@elenajs/core";
