const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/Playground.DM8GiwBf.js","assets/chunks/framework.C-jaY-rq.js"])))=>i.map(i=>d[i]);
import{_ as q,o as d,c as p,ae as U,j as l,n as x,F as C,z,t as j,Z as F,v as W,x as V,C as N,k as J,b as A,E as X,e as _,w as Z,T as K,L as Y,p as h,S as B,D as G,h as Q}from"./framework.C-jaY-rq.js";const ee={},te={class:"pg-loading-skeleton"};function se(e,t){return d(),p("div",te,[...t[0]||(t[0]=[U('<div class="pg-editor pg-editor-loading"><div class="pg-editor-tabs"><button class="pg-editor-tab active">HTML</button><button class="pg-editor-tab">CSS</button><button class="pg-editor-tab">JS</button></div><div class="pg-editor-container"></div></div><div class="pg-preview"><div class="pg-preview-header"><span class="pg-preview-title">Preview</span></div><div class="pg-preview-iframe"></div></div>',2)])])}const O=q(ee,[["render",se]]),ne={class:"pg-sidebar-nav"},ie={class:"pg-sidebar-heading"},ae={class:"pg-sidebar-items"},oe={class:"item"},re=["href","onClick"],le={class:"text"},ce={__name:"PlaygroundSidebar",props:{examples:{type:Array,required:!0},currentId:{type:String,default:""},open:{type:Boolean,default:!1}},emits:["select","toggle"],setup(e,{emit:t}){const s=t;return(o,n)=>(d(),p(C,null,[l("div",{class:x(["pg-sidebar-backdrop",{open:e.open}]),onClick:n[0]||(n[0]=r=>s("toggle"))},null,2),l("aside",{class:x(["pg-sidebar",{open:e.open}])},[l("nav",ne,[(d(!0),p(C,null,z(e.examples,r=>(d(),p("div",{key:r.category,class:"pg-sidebar-group"},[l("p",ie,j(r.category),1),l("div",ae,[(d(!0),p(C,null,z(r.items,c=>(d(),p("div",{key:c.id,class:x(["pg-sidebar-item",{"is-active":e.currentId===c.id}])},[l("div",oe,[n[1]||(n[1]=l("div",{class:"indicator"},null,-1)),l("a",{class:"link",href:"#"+c.id,onClick:F(u=>s("select",c.id),["prevent"])},[l("p",le,j(c.title),1)],8,re)])],2))),128))])]))),128))])],2)],64))}},de={id:"hello-world",title:"Hello World",js:`import { Elena, html } from "@elenajs/core";
...
<baseline-support featureid="anchor-positioning"></baseline-support>`},$e={id:"mixins",title:"Mixins",js:`import { Elena, html } from "@elenajs/core";
...
</div>`},ze={id:"shadow-dom",title:"Shadow DOM",js:`import { Elena, html } from "@elenajs/core";
...
</p>`},b=[{category:"Basics",items:[me,pe,ue,de]},{category:"Props",items:[he,fe,ye,be]},{category:"Templates",items:[ge,ve,xe,we]},{category:"Events",items:[ke,Ce,_e]},{category:"Lifecycle",items:[Ee,Se,Me]},{category:"Styling",items:[Le]},{category:"Advanced",items:[$e,ze,Te]}],je=`/**
 * @elenajs/core v1.0.0-rc.11
 * (c) 2025-present Ariel Salminen and Elena contributors
 * @license MIT
 */
const t="░█ [ELENA]: ",s=Array.isArray,i=Symbol("elena.raw"),n=s=>console.warn(t+s),e={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};function o(t){return s(t)?t.map(h).join(""):h(t)}function h(t){return t?.[i]?String(t):String(t??"").replace(/[&<>"']/g,t=>e[t])}class r{constructor(t,s){this.strings=t,this.values=s}toString(){return null==this.t&&(this.t=this.strings.reduce((t,s,i)=>t+s+o(this.values[i]),"")),this.t}}function c(t,...s){return new r(t,s)}function l(t){return{[i]:!0,toString:()=>t??""}}r.prototype[i]=!0;const u={[i]:!0,toString:()=>""},f=t=>s(t)?t.some(t=>t?.[i]):!!t?.[i],a=t=>s(t)?t.join(""):String(t??"");function d(t){return t.replace(/(>)\\n\\s*|\\n\\s*(<)/g,"$1$2").replace(/\\n\\s*/g," ").replace(/>\\s+</g,"><")}function p(t,s,i){if(s="boolean"===t&&"boolean"!=typeof s?null!==s:s,!i)return s;if("toAttribute"===i)switch(t){case"object":case"array":return s&&JSON.stringify(s);case"boolean":return s?"":null;default:return""===s?null:s}else switch(t){case"object":case"array":if(!s)return s;try{return JSON.parse(s)}catch{return n("Invalid JSON: "+s),null}case"number":return null!==s?+s:s;default:return s??""}}function b(t,s,i){t?null===i?t.removeAttribute(s):t.setAttribute(s,i):n("Cannot sync attrs.")}const g=new WeakMap,y="e"+Math.random().toString(36).slice(2),S=()=>document.createElement("template"),m=t=>document.createTreeWalker(t,128);function _(t,s){const i=\`\\x3c!--\${y}--\\x3e\`,n=[];let e="";for(let o=0;o<t.length;o++)if(e+=t[o],o<s){const s=t[o].match(/([^\\s"'>/=]+)\\s*=\\s*["']$/);s?(n.push(s[1]),e+=y+"_"+o):(n.push(null),e+=i)}const o=S();o.innerHTML=e.trim();const h=m(o.content);let r=0;for(;h.nextNode();)h.currentNode.data===y&&r++;return r!==n.filter(t=>null===t).length?null:{i:o,o:n}}function w(t,s){const i=Array.from(t.childNodes),n=Array.from(s),e=Math.max(i.length,n.length);for(let s=0;s<e;s++){const e=i[s],o=n[s];e?o?e.nodeType!==o.nodeType||1===e.nodeType&&e.tagName!==o.tagName?t.replaceChild(o,e):3===e.nodeType?e.textContent!==o.textContent&&(e.textContent=o.textContent):1===e.nodeType&&(v(e,o),w(e,o.childNodes)):t.removeChild(e):t.appendChild(o)}}function v(t,s){for(let i=t.attributes.length-1;i>=0;i--){const{name:n}=t.attributes[i];s.hasAttribute(n)||t.removeAttribute(n)}for(let i=0;i<s.attributes.length;i++){const{name:n,value:e}=s.attributes[i];t.getAttribute(n)!==e&&t.setAttribute(n,e)}}const C=new WeakSet,x=(t,s)=>Object.prototype.hasOwnProperty.call(t,s);function A(i){return class extends i{element=null;attributeChangedCallback(t,s,i){if(super.attributeChangedCallback?.(t,s,i),"text"!==t){if(s!==i)if(this.h&&!this.l){const s=this.u.get(t),n=typeof s,e="string"===n?i??"":p(n,i,"toProp");e!==s&&this.u.set(t,e),this.p()}else this.S=!0,function(t,s,i,e){if(i!==e){const i=typeof t[s];"undefined"===i&&n(\`Prop "\${s}" has no default.\`);const o=p(i,e,"toProp");t[s]=o}}(this,t,s,i),this.S=!1}else this.text=i??""}static get observedAttributes(){if(this.m)return this.m;const t=(this.props||[]).map(t=>"string"==typeof t?t:t.name);return this.m=[...t,"text"],this.m}connectedCallback(){super.connectedCallback?.(),this._(),this.v(),this.h||void 0!==this.C||(this.text=this.textContent.trim()),this.A(),this.k=this.M??this.shadowRoot??this,this.O??=()=>{try{this.P()}catch(s){console.error(t,s)}},this.willUpdate(),this.$(),this.N(),this.j(),this.h||(this.h=!0,this.setAttribute("hydrated",""),this.firstUpdated()),this.updated(),this.U()}_(){const t=this.constructor;if(C.has(t))return;const s=new Set,i=[];if(t.props){for(const n of t.props)"string"==typeof n?i.push(n):(i.push(n.name),!1===n.reflect&&s.add(n.name));i.includes("text")&&n('"text" is reserved.'),function(t,s,i){for(const n of s){const s=!i||!i.has(n);Object.defineProperty(t,n,{configurable:!0,enumerable:!0,get(){return this.u?.get(n)},set(t){if(this.u||(this.u=new Map),t!==this.u.get(n)&&(this.u.set(n,t),this.isConnected))if(s){if(!this.S){const s=p(typeof t,t,"toAttribute");b(this,n,s)}}else this.h&&!this.l&&this.p()}})}}(t.prototype,i,s)}if(t.q=i,t.J=s,t.L=t.events||null,t.L)for(const s of t.L)x(t.prototype,s)||(t.prototype[s]=function(...t){return this.element[s](...t)});var e;t.R=(e=t.element)?t=>t.querySelector(e):t=>t.firstElementChild,C.add(t)}v(){this.S=!0;for(const t of this.constructor.q)if(x(this,t)){const s=this[t];delete this[t],this[t]=s}this.S=!1}A(){const t=this.constructor;if(!t.shadow)return;this.M||this.shadowRoot||(this.M=this.attachShadow({mode:t.shadow}));const s=this.M??this.shadowRoot;if(t.styles){if(!t.W){const s=[t.styles].flat();t.W=s.map(t=>{if("string"==typeof t){const s=new CSSStyleSheet;return s.replaceSync(t),s}return t})}s.adoptedStyleSheets=t.W}}$(){const t=this.constructor,i=this.k,e=this.render();if(e&&e.strings&&!function(t,i,n){if(t.D!==i||!t.F)return!1;const e=t.F,o=t.I;for(let t=0;t<n.length;t++){const i=n[t],h=s(i)?a(i):i;if(h===o[t])continue;if(f(i)&&i!==u)return!1;const r=e[t];if(!r)return!1;o[t]=h;const c=String(h??"");r.nodeType?r.textContent=c:r[0].setAttribute(r[1],c)}return!0}(h=i,r=e.strings,c=e.values)&&(function(t,i,n){let e=g.get(i);if(!e){const t=i.map(d);e={T:t,B:n.length>0?_(t,n.length):null},g.set(i,e)}if(e.B)t.F=function(t,i,n){const{i:e,o:h}=i,r=e.content.cloneNode(!0),c=m(r),l=Array(n.length),d=[];let p;for(;p=c.nextNode();)p.data===y&&d.push(p);let b=0;for(let t=0;t<n.length;t++){const i=h[t];if(i){const e=r.querySelector(\`[\${i}="\${y+"_"+t}"]\`);if(e){const o=n[t],h=String((s(o)?a(o):o)??"");e.setAttribute(i,h),l[t]=[e,i]}}else{const s=d[b++],i=n[t];if(f(i)&&i!==u){const t=S();t.innerHTML=o(i),s.parentNode.replaceChild(t.content,s)}else{const n=document.createTextNode(a(i));s.parentNode.replaceChild(n,s),l[t]=n}}}return t.D?(w(t,r.childNodes),null):(t.replaceChildren(r),l)}(t,e.B,n);else{const s=n.map(o),i=e.T.reduce((t,i,n)=>t+i+(s[n]??""),"").replace(/>\\s+</g,"><").trim(),h=S();h.innerHTML=i,w(t,h.content.childNodes),t.F=null}t.D=i,t.I=n.map(t=>s(t)?a(t):t)}(h,r,c),1)){const s=this.element;if(this.element=t.R(i),this.G&&s&&this.element!==s){const i=t.L;for(const t of i)s.removeEventListener(t,this),this.element.addEventListener(t,this)}}var h,r,c;this.element||(this.element=t.R(i),this.element||(t.element&&n("Element not found."),this.element=i.firstElementChild))}N(){if(this.u){const t=this.constructor.J;for(const[s,i]of this.u){if(t.has(s))continue;const n=p(typeof i,i,"toAttribute");(null!==n||this.hasAttribute(s))&&b(this,s,n)}}}j(){const t=this.constructor.L;if(!this.G&&t?.length)if(this.element){this.G=!0;for(const s of t)this.element.addEventListener(s,this)}else n("Cannot add events.")}U(){const t=this.constructor;t.observe&&!t.shadow&&this.D&&"undefined"!=typeof MutationObserver&&(this.H||(this.H=new MutationObserver(()=>{this.element?.isConnected||(this.D=null,this.text=this.textContent.trim(),this.p())})),this.H.observe(this,{childList:!0}))}render(){}willUpdate(){}firstUpdated(){}updated(){}adoptedCallback(){super.adoptedCallback?.()}disconnectedCallback(){if(super.disconnectedCallback?.(),this.H?.disconnect(),this.G){this.G=!1;for(const t of this.constructor.L)this.element?.removeEventListener(t,this)}}handleEvent(t){this.constructor.L?.includes(t.type)&&(t.bubbles&&(t.composed||this.k===this)||this.dispatchEvent(new Event(t.type,{bubbles:t.bubbles})))}get text(){return this.C??""}set text(t){const s=this.C;this.C=t,this.h&&s!==t&&!this.l&&this.p()}static define(){const t=this.tagName;t?function(t,s){const i=globalThis.customElements;i?.get(t)||i?.define(t,s)}(t,this):n("define() without a tagName.")}p(){this.l||this.K||(this.K=!0,queueMicrotask(this.O))}P(){this.K=!1;const t=this.V;this.V=null;try{try{this.willUpdate(),this.l=!0,this.$()}finally{this.l=!1}this.updated()}finally{this.X=null,t?.()}}get updateComplete(){return this.K?(this.X||(this.X=new Promise(t=>{this.V=t})),this.X):Promise.resolve()}requestUpdate(){this.h&&!this.l&&this.p()}}}export{A as Elena,c as html,u as nothing,l as unsafeHTML};
`,H=je.replace(/\/\/# sourceMappingURL=.*$/m,"").trim(),Ne=typeof Blob<"u"?URL.createObjectURL(new Blob([H],{type:"text/javascript"})):`data:text/javascript;charset=utf-8,${encodeURIComponent(H)}`,Ae=JSON.stringify({imports:{"@elenajs/core":Ne}});function Pe(e,t,s){return`<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<script type="importmap">${Ae}<\/script>
<style>
body {
...
</html>`}function I(e,t){for(const s of e){const o=s.items.find(n=>n.id===t);if(o)return o}return null}function P(){return typeof window>"u"?null:window.location.hash.slice(1)||null}function R(e){typeof window>"u"||history.replaceState(null,"","#"+e)}function Re(e,t){let s;return function(...o){clearTimeout(s),s=setTimeout(()=>e.apply(this,o),t)}}function D(e){const t="https://unpkg.com/@elenajs/core/bundle";return e.replace(/from\s+["']@elenajs\/core["']/g,`from "${t}"`).replace(/import\s*\(\s*["']@elenajs\/core["']\s*\)/g,`import("${t}")`)}function De(e,t,s,o){const n=D(t),r=s?`<style>
${s}
</style>
`:"",c=`<!doctype html>
<html lang="en">
...
</html>`,u=(e||"component").toLowerCase().replace(/\s+/g,"-").replace(/[^a-z0-9-]/g,""),f=new Blob([c],{type:"text/html"}),g=URL.createObjectURL(f),y=document.createElement("a");y.href=g,y.download=`elena-${u}.html`,y.click(),URL.revokeObjectURL(g)}function qe(e,{js:t,css:s,html:o}){try{localStorage.setItem(`elena-pg:${e}`,JSON.stringify({js:t,css:s,html:o}))}catch{}}function Ue(e){try{const t=localStorage.getItem(`elena-pg:${e}`);if(!t)return null;const s=JSON.parse(t);return s&&typeof s.js=="string"&&typeof s.html=="string"?{js:s.js,css:s.css||"",html:s.html}:null}catch{return null}}function Fe(e){try{localStorage.removeItem(`elena-pg:${e}`)}catch{}}function We(e,t,s,o){const n=D(t);return JSON.stringify({title:`Elena | ${e||"Component"}`,html:o||"",css:s||"",js:n||"",js_module:!0,editors:"111"})}const Be={class:"pg-layout"},Oe={key:1,class:"pg-load-error"},He={__name:"PlaygroundWrapper",setup(e){const t=G(null),s=h(!1),o=h(!1),n=h(!1),r=h(""),c=h(null),u=h(null),f=h(!1),g=Q(()=>u.value==null?{}:{gridTemplateColumns:`${u.value}px 0px 1fr`});function y(i){i.preventDefault(),f.value=!0,document.addEventListener("pointermove",w),document.addEventListener("pointerup",k)}function w(i){if(!c.value)return;const a=c.value.getBoundingClientRect(),m=320,v=a.width-320;u.value=Math.min(v,Math.max(m,i.clientX-a.left))}function k(){f.value=!1,document.removeEventListener("pointermove",w),document.removeEventListener("pointerup",k)}function E(i){const a=I(b,i);a&&(r.value=a.id,R(a.id),n.value=!1)}function S(){const i=P();i&&i!==r.value&&E(i)}function M(){u.value=null}async function L(){s.value=!1;try{const i=await B(()=>import("./Playground.DM8GiwBf.js"),__vite__mapDeps([0,1]));t.value=i.default}catch{try{const i=await B(()=>import("./Playground.DM8GiwBf.js"),__vite__mapDeps([0,1]));t.value=i.default}catch{s.value=!0}}}return W(async()=>{var v,T,$;window.addEventListener("resize",M);const i=P(),a=((T=(v=b[0])==null?void 0:v.items[0])==null?void 0:T.id)||"primitive-component",m=I(b,i||a)||(($=b[0])==null?void 0:$.items[0]);r.value=(m==null?void 0:m.id)||"",i||R(r.value),window.addEventListener("hashchange",S),await L()}),V(()=>{window.removeEventListener("resize",M),window.removeEventListener("hashchange",S),document.removeEventListener("pointermove",w),document.removeEventListener("pointerup",k)}),(i,a)=>(d(),p("div",Be,[N(ce,{examples:J(b),"current-id":r.value,open:n.value,onSelect:E,onToggle:a[0]||(a[0]=m=>n.value=!n.value)},null,8,["examples","current-id","open"]),l("div",{ref_key:"mainRef",ref:c,class:x(["pg-main",{"pg-resizing":f.value}]),style:Y(g.value)},[(d(),A(X(t.value||O),{"current-id":r.value,onPreviewReady:a[1]||(a[1]=m=>o.value=!0),onToggleSidebar:a[2]||(a[2]=m=>n.value=!n.value)},null,40,["current-id"])),o.value?(d(),p("div",{key:0,class:"pg-resize-handle",onPointerdown:y},null,32)):_("",!0),N(K,{name:"pg-unload"},{default:Z(()=>[t.value&&!o.value?(d(),A(O,{key:0,class:"pg-loading-overlay"})):_("",!0)]),_:1}),s.value?(d(),p("div",Oe,[a[3]||(a[3]=l("p",null,"Failed to load the playground.",-1)),l("button",{onClick:L},"Try again")])):_("",!0)],6)]))}},Ve=Object.freeze(Object.defineProperty({__proto__:null,default:He},Symbol.toStringTag,{value:"Module"}));export{Ve as P,De as a,We as b,Fe as c,Re as d,b as e,I as f,Pe as g,Ue as l,qe as s};
