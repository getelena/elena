const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/Playground.mNcNlK3B.js","assets/chunks/framework.C-jaY-rq.js"])))=>i.map(i=>d[i]);
import{_ as D,o as d,c as p,ae as q,j as l,n as x,F as C,z as $,t as j,Z as F,v as W,x as J,C as N,k as V,b as B,E as Z,e as _,w as Y,T as X,L as G,p as h,S as A,D as K,h as Q}from"./framework.C-jaY-rq.js";const ee={},te={class:"pg-loading-skeleton"};function se(e,t){return d(),p("div",te,[...t[0]||(t[0]=[q('<div class="pg-editor pg-editor-loading"><div class="pg-editor-tabs"><button class="pg-editor-tab active">HTML</button><button class="pg-editor-tab">CSS</button><button class="pg-editor-tab">JS</button></div><div class="pg-editor-container"></div></div><div class="pg-preview"><div class="pg-preview-header"><span class="pg-preview-title">Preview</span></div><div class="pg-preview-iframe"></div></div>',2)])])}const O=D(ee,[["render",se]]),ne={class:"pg-sidebar-nav"},ae={class:"pg-sidebar-heading"},ie={class:"pg-sidebar-items"},oe={class:"item"},re=["href","onClick"],le={class:"text"},ce={__name:"PlaygroundSidebar",props:{examples:{type:Array,required:!0},currentId:{type:String,default:""},open:{type:Boolean,default:!1}},emits:["select","toggle"],setup(e,{emit:t}){const s=t;return(o,n)=>(d(),p(C,null,[l("div",{class:x(["pg-sidebar-backdrop",{open:e.open}]),onClick:n[0]||(n[0]=r=>s("toggle"))},null,2),l("aside",{class:x(["pg-sidebar",{open:e.open}])},[l("nav",ne,[(d(!0),p(C,null,$(e.examples,r=>(d(),p("div",{key:r.category,class:"pg-sidebar-group"},[l("p",ae,j(r.category),1),l("div",ie,[(d(!0),p(C,null,$(r.items,c=>(d(),p("div",{key:c.id,class:x(["pg-sidebar-item",{"is-active":e.currentId===c.id}])},[l("div",oe,[n[1]||(n[1]=l("div",{class:"indicator"},null,-1)),l("a",{class:"link",href:"#"+c.id,onClick:F(u=>s("select",c.id),["prevent"])},[l("p",le,j(c.title),1)],8,re)])],2))),128))])]))),128))])],2)],64))}},de={id:"hello-world",title:"Hello World",js:`import { Elena, html } from "@elenajs/core";
 ...
 * @license MIT
 */
const t="░█ [ELENA]: ",s=Array.isArray,i=s=>console.warn(t+s),e={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};function n(t){return s(t)?t.map(o).join(""):o(t)}function o(t){return t?.t?String(t):String(t??"").replace(/[&<>"']/g,t=>e[t])}function r(t,...s){let i;return{t:!0,strings:t,values:s,toString:()=>(null==i&&(i=t.reduce((t,i,e)=>t+i+n(s[e]),"")),i)}}function h(t){return{t:!0,toString:()=>t??""}}const c={t:!0,toString:()=>""},u=t=>s(t)?t.some(t=>t?.t):t?.t,f=t=>s(t)?t.join(""):String(t??"");function l(t){return t.replace(/(>)\\n\\s*|\\n\\s*(<)/g,"$1$2").replace(/\\n\\s*/g," ").replace(/>\\s+</g,"><")}function a(t,s,e){if(s="boolean"===t&&"boolean"!=typeof s?null!==s:s,!e)return s;if("toAttribute"===e)switch(t){case"object":case"array":return s&&JSON.stringify(s);case"boolean":return s?"":null;default:return""===s?null:s}else switch(t){case"object":case"array":if(!s)return s;try{return JSON.parse(s)}catch{return i("Invalid JSON: "+s),null}case"number":return null!==s?+s:s;default:return s??""}}function d(t,s,e){t?null===e?t.removeAttribute(s):t.setAttribute(s,e):i("Cannot sync attrs.")}const p=new WeakMap,b="e"+(1e5*Math.random()|0),g=()=>document.createElement("template"),y=t=>document.createTreeWalker(t,128);function m(t,i,e){return!function(t,i,e){if(t.i!==i||!t.o)return!1;for(let i=0;i<e.length;i++){const n=e[i],o=s(n)?f(n):n;if(o!==t.h[i]){if(u(n)||!t.o[i])return!1;t.h[i]=o,t.o[i].textContent=f(n)}}return!0}(t,i,e)&&(function(t,i,e){let o=p.get(i);if(!o){const t=i.map(l);o={u:t,l:e.length>0?_(t,e.length):null},p.set(i,o)}if(o.l)t.o=function(t,s,i){const e=s.content.cloneNode(!0),o=y(e),r=Array(i.length),h=[];let c;for(;c=o.nextNode();)c.data===b&&h.push(c);for(let t=0;t<h.length;t++){const s=i[t];if(u(s)){const i=g();i.innerHTML=n(s),h[t].parentNode.replaceChild(i.content,h[t])}else{const i=document.createTextNode(f(s));h[t].parentNode.replaceChild(i,h[t]),r[t]=i}}return t.replaceChildren(e),r}(t,o.l,e);else{const s=e.map(n),i=o.u.reduce((t,i,e)=>t+i+(s[e]??""),"").replace(/>\\s+</g,"><").trim(),r=g();r.innerHTML=i,S(t,r.content.childNodes),t.o=null}t.i=i,t.h=e.map(t=>s(t)?f(t):t)}(t,i,e),!0)}function _(t,s){const i=\`\\x3c!--\${b}--\\x3e\`,e=t.reduce((t,e,n)=>t+e+(n<s?i:""),"").trim(),n=g();n.innerHTML=e;const o=y(n.content);let r=0;for(;o.nextNode();)o.currentNode.data===b&&r++;return r===s?n:null}function S(t,s){const i=Array.from(t.childNodes),e=Array.from(s),n=Math.max(i.length,e.length);for(let s=0;s<n;s++){const n=i[s],o=e[s];n?o?n.nodeType!==o.nodeType||1===n.nodeType&&n.tagName!==o.tagName?t.replaceChild(o,n):3===n.nodeType?n.textContent!==o.textContent&&(n.textContent=o.textContent):1===n.nodeType&&(w(n,o),S(n,o.childNodes)):t.removeChild(n):t.appendChild(o)}}function w(t,s){for(let i=t.attributes.length-1;i>=0;i--){const{name:e}=t.attributes[i];s.hasAttribute(e)||t.removeAttribute(e)}for(let i=0;i<s.attributes.length;i++){const{name:e,value:n}=s.attributes[i];t.getAttribute(e)!==n&&t.setAttribute(e,n)}}const v=new WeakSet,C=(t,s)=>Object.prototype.hasOwnProperty.call(t,s);function x(s){return class extends s{element=null;attributeChangedCallback(t,s,e){super.attributeChangedCallback?.(t,s,e),"text"!==t?(this.p=!0,function(t,s,e,n){if(e!==n){const e=typeof t[s];"undefined"===e&&i(\`Prop "\${s}" has no default.\`);const o=a(e,n,"toProp");t[s]=o}}(this,t,s,e),this.p=!1,this.m&&s!==e&&!this._&&this.S()):this.text=e??""}static get observedAttributes(){if(this.v)return this.v;const t=(this.props||[]).map(t=>"string"==typeof t?t:t.name);return this.v=[...t,"text"],this.v}connectedCallback(){super.connectedCallback?.(),this.C(),this.A(),this.m||void 0!==this.k||(this.text=this.textContent.trim()),this.M(),this.willUpdate(),this.O(),this.P(),this.N(),this.m||(this.m=!0,this.setAttribute("hydrated",""),this.firstUpdated()),this.updated(),this.j()}C(){const t=this.constructor;if(v.has(t))return;const s=new Set,e=[];if(t.props){for(const i of t.props)"string"==typeof i?e.push(i):(e.push(i.name),!1===i.reflect&&s.add(i.name));e.includes("text")&&i('"text" is reserved.'),function(t,s,i){for(const e of s){const s=!i||!i.has(e);Object.defineProperty(t,e,{configurable:!0,enumerable:!0,get(){return this.U?.get(e)},set(t){if(this.U||(this.U=new Map),t!==this.U.get(e)&&(this.U.set(e,t),this.isConnected))if(s){if(!this.p){const s=a(typeof t,t,"toAttribute");d(this,e,s)}}else this.m&&!this._&&this.S()}})}}(t.prototype,e,s)}if(t.$=e,t.q=s,t.J=t.events||null,t.J)for(const s of t.J)C(t.prototype,s)||(t.prototype[s]=function(...t){return this.element[s](...t)});var n;t.R=(n=t.element)?t=>t.querySelector(n):t=>t.firstElementChild,v.add(t)}A(){this.p=!0;for(const t of this.constructor.$)if(C(this,t)){const s=this[t];delete this[t],this[t]=s}this.p=!1}get L(){return this.W??this.shadowRoot??this}M(){const t=this.constructor;if(!t.shadow)return;this.W||this.shadowRoot||(this.W=this.attachShadow({mode:t.shadow}));const s=this.W??this.shadowRoot;if(t.styles){if(!t.D){const s=[t.styles].flat();t.D=s.map(t=>{if("string"==typeof t){const s=new CSSStyleSheet;return s.replaceSync(t),s}return t})}s.adoptedStyleSheets=t.D}}O(){const t=this.constructor,s=this.L,e=this.render();if(e&&e.strings&&m(s,e.strings,e.values)){const i=this.element;if(this.element=t.R(s),this.F&&i&&this.element!==i){const s=t.J;for(const t of s)i.removeEventListener(t,this),this.element.addEventListener(t,this)}}this.element||(this.element=t.R(s),this.element||(t.element&&i("Element not found."),this.element=s.firstElementChild))}P(){if(this.U){const t=this.constructor.q;for(const[s,i]of this.U){if(t.has(s))continue;const e=a(typeof i,i,"toAttribute");(null!==e||this.hasAttribute(s))&&d(this,s,e)}}}N(){const t=this.constructor.J;if(!this.F&&t?.length)if(this.element){this.F=!0;for(const s of t)this.element.addEventListener(s,this)}else i("Cannot add events.")}j(){const t=this.constructor;t.observe&&!t.shadow&&this.i&&"undefined"!=typeof MutationObserver&&(this.I||(this.I=new MutationObserver(()=>{this.element?.isConnected||(this.i=null,this.text=this.textContent.trim(),this.S())})),this.I.observe(this,{childList:!0}))}render(){}willUpdate(){}firstUpdated(){}updated(){}adoptedCallback(){super.adoptedCallback?.()}disconnectedCallback(){if(super.disconnectedCallback?.(),this.I?.disconnect(),this.F){this.F=!1;for(const t of this.constructor.J)this.element?.removeEventListener(t,this)}}handleEvent(t){this.constructor.J?.includes(t.type)&&(t.bubbles&&(t.composed||this.L===this)||this.dispatchEvent(new Event(t.type,{bubbles:t.bubbles})))}get text(){return this.k??""}set text(t){const s=this.k;this.k=t,this.m&&s!==t&&!this._&&this.S()}static define(){const t=this.tagName;t?function(t,s){const i=globalThis.customElements;i?.get(t)||i?.define(t,s)}(t,this):i("define() without a tagName.")}S(){this._||this.T||(this.T=!0,this.B=new Promise(t=>{this.G=t}),queueMicrotask(()=>{try{this.H()}catch(s){console.error(t,s)}}))}H(){this.T=!1;const t=this.G;this.G=null;try{try{this.willUpdate(),this._=!0,this.O()}finally{this._=!1}this.updated()}finally{this.B=null,t()}}get updateComplete(){return this.B||Promise.resolve()}requestUpdate(){this.m&&!this._&&this.S()}}}export{x as Elena,r as html,c as nothing,h as unsafeHTML};
`,I=je.replace(/\/\/# sourceMappingURL=.*$/m,"").trim(),Ne=typeof Blob<"u"?URL.createObjectURL(new Blob([I],{type:"text/javascript"})):`data:text/javascript;charset=utf-8,${encodeURIComponent(I)}`,Be=JSON.stringify({imports:{"@elenajs/core":Ne}});function Pe(e,t,s){return`<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
</html>`}function H(e,t){for(const s of e){const o=s.items.find(n=>n.id===t);if(o)return o}return null}function P(){return typeof window>"u"?null:window.location.hash.slice(1)||null}function R(e){typeof window>"u"||history.replaceState(null,"","#"+e)}function Re(e,t){let s;return function(...o){clearTimeout(s),s=setTimeout(()=>e.apply(this,o),t)}}function U(e){const t="https://unpkg.com/@elenajs/core/bundle";return e.replace(/from\s+["']@elenajs\/core["']/g,`from "${t}"`).replace(/import\s*\(\s*["']@elenajs\/core["']\s*\)/g,`import("${t}")`)}function Ue(e,t,s,o){const n=U(t),r=s?`<style>
${s}
</style>
`:"",c=`<!doctype html>
<html lang="en">
...
</html>`,u=(e||"component").toLowerCase().replace(/\s+/g,"-").replace(/[^a-z0-9-]/g,""),f=new Blob([c],{type:"text/html"}),g=URL.createObjectURL(f),y=document.createElement("a");y.href=g,y.download=`elena-${u}.html`,y.click(),URL.revokeObjectURL(g)}function De(e,{js:t,css:s,html:o}){try{localStorage.setItem(`elena-pg:${e}`,JSON.stringify({js:t,css:s,html:o}))}catch{}}function qe(e){try{const t=localStorage.getItem(`elena-pg:${e}`);if(!t)return null;const s=JSON.parse(t);return s&&typeof s.js=="string"&&typeof s.html=="string"?{js:s.js,css:s.css||"",html:s.html}:null}catch{return null}}function Fe(e){try{localStorage.removeItem(`elena-pg:${e}`)}catch{}}function We(e,t,s,o){const n=U(t);return JSON.stringify({title:`Elena | ${e||"Component"}`,html:o||"",css:s||"",js:n||"",js_module:!0,editors:"111"})}const Ae={class:"pg-layout"},Oe={key:1,class:"pg-load-error"},Ie={__name:"PlaygroundWrapper",setup(e){const t=K(null),s=h(!1),o=h(!1),n=h(!1),r=h(""),c=h(null),u=h(null),f=h(!1),g=Q(()=>u.value==null?{}:{gridTemplateColumns:`${u.value}px 0px 1fr`});function y(a){a.preventDefault(),f.value=!0,document.addEventListener("pointermove",w),document.addEventListener("pointerup",k)}function w(a){if(!c.value)return;const i=c.value.getBoundingClientRect(),m=320,v=i.width-320;u.value=Math.min(v,Math.max(m,a.clientX-i.left))}function k(){f.value=!1,document.removeEventListener("pointermove",w),document.removeEventListener("pointerup",k)}function E(a){const i=H(b,a);i&&(r.value=i.id,R(i.id),n.value=!1)}function S(){const a=P();a&&a!==r.value&&E(a)}function M(){u.value=null}async function L(){s.value=!1;try{const a=await A(()=>import("./Playground.mNcNlK3B.js"),__vite__mapDeps([0,1]));t.value=a.default}catch{try{const a=await A(()=>import("./Playground.mNcNlK3B.js"),__vite__mapDeps([0,1]));t.value=a.default}catch{s.value=!0}}}return W(async()=>{var v,T,z;window.addEventListener("resize",M);const a=P(),i=((T=(v=b[0])==null?void 0:v.items[0])==null?void 0:T.id)||"primitive-component",m=H(b,a||i)||((z=b[0])==null?void 0:z.items[0]);r.value=(m==null?void 0:m.id)||"",a||R(r.value),window.addEventListener("hashchange",S),await L()}),J(()=>{window.removeEventListener("resize",M),window.removeEventListener("hashchange",S),document.removeEventListener("pointermove",w),document.removeEventListener("pointerup",k)}),(a,i)=>(d(),p("div",Ae,[N(ce,{examples:V(b),"current-id":r.value,open:n.value,onSelect:E,onToggle:i[0]||(i[0]=m=>n.value=!n.value)},null,8,["examples","current-id","open"]),l("div",{ref_key:"mainRef",ref:c,class:x(["pg-main",{"pg-resizing":f.value}]),style:G(g.value)},[(d(),B(Z(t.value||O),{"current-id":r.value,onPreviewReady:i[1]||(i[1]=m=>o.value=!0),onToggleSidebar:i[2]||(i[2]=m=>n.value=!n.value)},null,40,["current-id"])),o.value?(d(),p("div",{key:0,class:"pg-resize-handle",onPointerdown:y},null,32)):_("",!0),N(X,{name:"pg-unload"},{default:Y(()=>[t.value&&!o.value?(d(),B(O,{key:0,class:"pg-loading-overlay"})):_("",!0)]),_:1}),s.value?(d(),p("div",Oe,[i[3]||(i[3]=l("p",null,"Failed to load the playground.",-1)),l("button",{onClick:L},"Try again")])):_("",!0)],6)]))}},Je=Object.freeze(Object.defineProperty({__proto__:null,default:Ie},Symbol.toStringTag,{value:"Module"}));export{Je as P,Ue as a,We as b,Fe as c,Re as d,b as e,H as f,Pe as g,qe as l,De as s};
