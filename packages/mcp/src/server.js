 ...
 */
const INSTRUCTIONS = `You are working with Elena, a lightweight (2.6kB) library for building Progressive Web Components. Elena renders base HTML & CSS first, then progressively enhances with JavaScript. Zero runtime dependencies.
