      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "- [ ] Correct component type (components with render() own their DOM; HTML Web Components wrap children with no render())",
              "- [ ] Components with render(): render() returns html tagged template",
              "- [ ] Components with render(): static element points to inner element selector",
              "- [ ] HTML Web Components: no render(), no static events, no static element",
              ...
              "- [ ] Components with render(): encapsulation reset uses the correct form: :scope, *:where(:not(img, svg):not(svg *)), *::before, *::after { all: unset; display: revert; }",
              "- [ ] :scope has an explicit display mode set (e.g. display: inline-block or display: flex)",
              "- [ ] HTML Web Components: CSS has NO all: unset encapsulation reset block",
              "- [ ] Components with render(): :scope:not([hydrated]) and inner element share baseline styles",
              ...
              "- [ ] Components with render(): text property used instead of children for dynamic framework content",
              "- [ ] Components with render(): pre-hydration CSS styles avoid layout shifts for SSR",
            ]
              .filter(Boolean)
              .join("\n"),
          },
