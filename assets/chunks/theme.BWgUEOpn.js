...
</html>`}function Se(e,t){for(const n of e){const s=n.items.find(a=>a.id===t);if(s)return s}return null}function Pe(){return typeof window>"u"?null:window.location.hash.slice(1)||null}function Me(e){typeof window>"u"||history.replaceState(null,"","#"+e)}function Pi(e,t){let n;return function(...s){clearTimeout(n),n=setTimeout(()=>e.apply(this,s),t)}}const xi={class:"pg-layout"},wi={class:"pg-main"},$i={__name:"PlaygroundWrapper",setup(e){const t=ve(null),n=S(!1),s=S(!1),a=S("");function r(p){const u=Se(G,p);u&&(a.value=u.id,Me(u.id),s.value=!1)}function l(){const p=Pe();p&&p!==a.value&&r(p)}return z(async()=>{var y,w,P;const p=Pe(),u=((w=(y=G[0])==null?void 0:y.items[0])==null?void 0:w.id)||"primitive-component",k=Se(G,p||u)||((P=G[0])==null?void 0:P.items[0]);a.value=(k==null?void 0:k.id)||"",p||Me(a.value),window.addEventListener("hashchange",l);const L=await Ne(()=>import("./Playground.RoaWALR5.js"),__vite__mapDeps([2,1]));t.value=L.default}),ne(()=>{window.removeEventListener("hashchange",l)}),(p,u)=>(o(),c("div",xi,[b(Jo,{examples:i(G),"current-id":a.value,open:s.value,onSelect:r,onToggle:u[0]||(u[0]=k=>s.value=!s.value)},null,8,["examples","current-id","open"]),m("div",wi,[(o(),g(B(t.value||Le),{"current-id":a.value,onPreviewReady:u[1]||(u[1]=k=>n.value=!0),onToggleSidebar:u[2]||(u[2]=k=>s.value=!s.value)},null,40,["current-id"])),b(ee,{name:"pg-unload"},{default:f(()=>[t.value&&!n.value?(o(),g(Le,{key:0,class:"pg-loading-overlay"})):h("",!0)]),_:1})])]))}},Mi={extends:Bo,setup(){Oo(K())},enhanceApp({app:e}){e.component("Playground",$i)}};export{Mi as R,ba as c,Pi as d,G as e,Se as f,Si as g,$ as u};
