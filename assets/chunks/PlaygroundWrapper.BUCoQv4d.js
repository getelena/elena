...
</html>`,u=(e||"component").toLowerCase().replace(/\s+/g,"-").replace(/[^a-z0-9-]/g,""),f=new Blob([c],{type:"text/html"}),g=URL.createObjectURL(f),y=document.createElement("a");y.href=g,y.download=`elena-${u}.html`,y.click(),URL.revokeObjectURL(g)}function qe(e,{js:t,css:s,html:o}){try{localStorage.setItem(`elena-pg:${e}`,JSON.stringify({js:t,css:s,html:o}))}catch{}}function Ue(e){try{const t=localStorage.getItem(`elena-pg:${e}`);if(!t)return null;const s=JSON.parse(t);return s&&typeof s.js=="string"&&typeof s.html=="string"?{js:s.js,css:s.css||"",html:s.html}:null}catch{return null}}function Fe(e){try{localStorage.removeItem(`elena-pg:${e}`)}catch{}}function We(){try{return localStorage.getItem("elena-pg:autosave")!=="false"}catch{return!0}}function Ve(e){try{localStorage.setItem("elena-pg:autosave",String(e))}catch{}}function Je(e,t,s,o){const n=D(t);return JSON.stringify({title:`Elena | ${e||"Component"}`,html:o||"",css:s||"",js:n||"",js_module:!0,editors:"111"})}const Oe={class:"pg-layout"},Be={key:1,class:"pg-load-error"},Ie={__name:"PlaygroundWrapper",setup(e){const t=G(null),s=h(!1),o=h(!1),n=h(!1),r=h(""),c=h(null),u=h(null),f=h(!1),g=Q(()=>u.value==null?{}:{gridTemplateColumns:`${u.value}px 0px 1fr`});function y(a){a.preventDefault(),f.value=!0,document.addEventListener("pointermove",x),document.addEventListener("pointerup",k)}function x(a){if(!c.value)return;const i=c.value.getBoundingClientRect(),m=320,v=i.width-320;u.value=Math.min(v,Math.max(m,a.clientX-i.left))}function k(){f.value=!1,document.removeEventListener("pointermove",x),document.removeEventListener("pointerup",k)}function _(a){const i=H(b,a);i&&(r.value=i.id,R(i.id),n.value=!1)}function M(){const a=P();a&&a!==r.value&&_(a)}function S(){u.value=null}async function L(){s.value=!1;try{const a=await O(()=>import("./Playground.-K0m3QZC.js"),__vite__mapDeps([0,1]));t.value=a.default}catch{try{const a=await O(()=>import("./Playground.-K0m3QZC.js"),__vite__mapDeps([0,1]));t.value=a.default}catch{s.value=!0}}}return W(async()=>{var v,T,N;window.addEventListener("resize",S);const a=P(),i=((T=(v=b[0])==null?void 0:v.items[0])==null?void 0:T.id)||"primitive-component",m=H(b,a||i)||((N=b[0])==null?void 0:N.items[0]);r.value=(m==null?void 0:m.id)||"",a||R(r.value),window.addEventListener("hashchange",M),await L()}),V(()=>{window.removeEventListener("resize",S),window.removeEventListener("hashchange",M),document.removeEventListener("pointermove",x),document.removeEventListener("pointerup",k)}),(a,i)=>(d(),p("div",Oe,[A(ce,{examples:J(b),"current-id":r.value,open:n.value,onSelect:_,onToggle:i[0]||(i[0]=m=>n.value=!n.value)},null,8,["examples","current-id","open"]),l("div",{ref_key:"mainRef",ref:c,class:w(["pg-main",{"pg-resizing":f.value}]),style:K(g.value)},[(d(),j(Z(t.value||B),{"current-id":r.value,onPreviewReady:i[1]||(i[1]=m=>o.value=!0),onToggleSidebar:i[2]||(i[2]=m=>n.value=!n.value)},null,40,["current-id"])),o.value?(d(),p("div",{key:0,class:"pg-resize-handle",onPointerdown:y},null,32)):C("",!0),A(X,{name:"pg-unload"},{default:Y(()=>[t.value&&!o.value?(d(),j(B,{key:0,class:"pg-loading-overlay"})):C("",!0)]),_:1}),s.value?(d(),p("div",Be,[i[3]||(i[3]=l("p",null,"Failed to load the playground.",-1)),l("button",{onClick:L},"Try again")])):C("",!0)],6)]))}},Ze=Object.freeze(Object.defineProperty({__proto__:null,default:Ie},Symbol.toStringTag,{value:"Module"}));export{Ze as P,De as a,Je as b,Ue as c,Re as d,Fe as e,H as f,Pe as g,b as h,qe as i,We as l,Ve as s};
