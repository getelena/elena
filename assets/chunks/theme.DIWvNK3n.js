...
my-tags input:focus {
  outline: 2px solid #5a44d4;
  outline-offset: -1px;
}`,html:"<my-tags></my-tags>"},Di={id:"css-custom-properties",title:"CSS Custom Properties",js:`import { Elena, html } from "@elenajs/core";
...
<my-button class="brand-theme">Brand Theme</my-button>`},ji={id:"baseline-support",title:"Baseline Support",js:`import { Elena, html, unsafeHTML, nothing } from "@elenajs/core";
...
</html>`,m=(e||"component").toLowerCase().replace(/\s+/g,"-").replace(/[^a-z0-9-]/g,""),p=new Blob([c],{type:"text/html"}),_=URL.createObjectURL(p),w=document.createElement("a");w.href=_,w.download=`elena-${m}.html`,w.click(),URL.revokeObjectURL(_)}function sr(e,t,n,s){const a=Re(t);return JSON.stringify({title:`Elena | ${e||"Component"}`,html:s||"",css:n||"",js:a||"",js_module:!0,editors:"111"})}const Gi={class:"pg-layout"},Ji={key:1,class:"pg-load-error"},Ki={__name:"PlaygroundWrapper",setup(e){const t=ge(null),n=S(!1),s=S(!1),a=S(!1),i=S(""),c=S(null),m=S(null),p=S(!1),_=$(()=>m.value==null?{}:{gridTemplateColumns:`${m.value}px 0px 1fr`});function w(C){C.preventDefault(),p.value=!0,document.addEventListener("pointermove",k),document.addEventListener("pointerup",x)}function k(C){if(!c.value)return;const N=c.value.getBoundingClientRect(),H=200,R=N.width-200;m.value=Math.min(R,Math.max(H,C.clientX-N.left))}function x(){p.value=!1,document.removeEventListener("pointermove",k),document.removeEventListener("pointerup",x)}function E(C){const N=Ce(K,C);N&&(i.value=N.id,Ne(N.id),a.value=!1)}function V(){const C=Te();C&&C!==i.value&&E(C)}function A(){m.value=null}async function B(){n.value=!1;try{const C=await me(()=>import("./Playground.DfLOfHvk.js"),__vite__mapDeps([2,1]));t.value=C.default}catch{try{const C=await me(()=>import("./Playground.DfLOfHvk.js"),__vite__mapDeps([2,1]));t.value=C.default}catch{n.value=!0}}}return j(async()=>{var R,J,Se;window.addEventListener("resize",A);const C=Te(),N=((J=(R=K[0])==null?void 0:R.items[0])==null?void 0:J.id)||"primitive-component",H=Ce(K,C||N)||((Se=K[0])==null?void 0:Se.items[0]);i.value=(H==null?void 0:H.id)||"",C||Ne(i.value),window.addEventListener("hashchange",V),await B()}),ae(()=>{window.removeEventListener("resize",A),window.removeEventListener("hashchange",V),document.removeEventListener("pointermove",k),document.removeEventListener("pointerup",x)}),(C,N)=>(o(),l("div",Gi,[b(_i,{examples:r(K),"current-id":i.value,open:a.value,onSelect:E,onToggle:N[0]||(N[0]=H=>a.value=!a.value)},null,8,["examples","current-id","open"]),u("div",{ref_key:"mainRef",ref:c,class:P(["pg-main",{"pg-resizing":p.value}]),style:ye(_.value)},[(o(),g(z(t.value||Me),{"current-id":i.value,onPreviewReady:N[1]||(N[1]=H=>s.value=!0),onToggleSidebar:N[2]||(N[2]=H=>a.value=!a.value)},null,40,["current-id"])),s.value?(o(),l("div",{key:0,class:"pg-resize-handle",onPointerdown:w},null,32)):h("",!0),b(ne,{name:"pg-unload"},{default:f(()=>[t.value&&!s.value?(o(),g(Me,{key:0,class:"pg-loading-overlay"})):h("",!0)]),_:1}),n.value?(o(),l("div",Ji,[N[3]||(N[3]=u("p",null,"Failed to load the playground.",-1)),u("button",{onClick:B},"Try again")])):h("",!0)],6)]))}},ar={extends:li,setup(){di(Y())},enhanceApp({app:e}){e.component("Playground",Ki)}};export{ar as R,Qi as V,Xi as a,Zi as b,sr as c,nr as d,tr as e,K as f,er as g,Ce as h,ka as i,L as u};
