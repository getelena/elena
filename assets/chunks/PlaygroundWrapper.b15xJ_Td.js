const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/Playground.CTo2RCzU.js","assets/chunks/framework.D73iOW4a.js"])))=>i.map(i=>d[i]);
...
</p>`},b=[{category:"Basics",items:[me,pe,ue,de]},{category:"Props",items:[he,fe,ye,be]},{category:"Templates",items:[ge,ve,we,xe]},{category:"Events",items:[ke,Ee,Ce]},{category:"Lifecycle",items:[_e,Me,Se]},{category:"Styling",items:[Le]},{category:"Advanced",items:[Ne,ze,Te]}],$e=`/**
 * @elenajs/core v1.0.0-rc.6
