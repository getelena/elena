...
MyGreeting.define();`,html:'<my-greeting name="Elena"></my-greeting>'},Yo={id:"composite-component",title:"Composite Component",js:`import { Elena } from "@elenajs/core";
...
<my-button variant="danger">Danger</my-button>`},Xo={id:"declarative-component",title:"Declarative Component",js:`import { Elena } from "@elenajs/core";
...
<my-button>
  ...
  Cancel
</my-button>`},Qo={id:"string-props",title:"String Props",js:`import { Elena, html } from "@elenajs/core";
...
<my-badge variant="error">Error</my-badge>`},ei={id:"boolean-props",title:"Boolean Props",js:`import { Elena, html } from "@elenajs/core";
...
<my-checkbox disabled label="Disabled"></my-checkbox>`},ti={id:"number-props",title:"Number Props",js:`import { Elena, html } from "@elenajs/core";
...
<my-counter count="10" step="5" max="95"></my-counter>`},ni={id:"array-object-props",title:"Array/Object Props",js:`import { Elena, html } from "@elenajs/core";
...
></my-list>`},si={id:"conditional-rendering",title:"Conditional Rendering",js:`import { Elena, html, nothing } from "@elenajs/core";
...
<my-alert variant="warning" dismissible>This warning can be dismissed.</my-alert>`},ai={id:"list-rendering",title:"List Rendering",js:`import { Elena, html } from "@elenajs/core";
...
}`,html:"<my-list></my-list>"},oi={id:"unsafe-html",title:"unsafeHTML",js:`import { Elena, html, unsafeHTML } from "@elenajs/core";
...
<my-icon name="check" style="color: #48bb78"></my-icon>`},ii={id:"element-ref",title:"Element Ref",js:`import { Elena, html } from "@elenajs/core";
...
my-input input:focus {
  outline: 2px solid #5a44d4;
  outline-offset: -1px;
}`,html:'<my-input label="Character counter"></my-input>'},ri={id:"delegated-events",title:"Delegated Events",js:`import { Elena, html } from "@elenajs/core";
...
<pre id="log"></pre>`},li={id:"custom-events",title:"Custom Events",js:`import { Elena, html } from "@elenajs/core";
...
<p id="output">Click a star to rate.</p>`},ci={id:"manual-listeners",title:"Manual Listeners",js:`import { Elena, html } from "@elenajs/core";
...
}`,html:"<my-key-logger></my-key-logger>"},di={id:"will-update",title:"willUpdate",js:`import { Elena, html } from "@elenajs/core";
...
my-filter input:focus {
  outline: 2px solid #5a44d4;
  outline-offset: -1px;
}`,html:"<my-filter></my-filter>"},ui={id:"first-updated",title:"firstUpdated",js:`import { Elena, html } from "@elenajs/core";
...
}`,html:"<my-card></my-card>"},mi={id:"request-update",title:"requestUpdate",js:`import { Elena, html } from "@elenajs/core";
...
my-tags input:focus {
  outline: 2px solid #5a44d4;
  outline-offset: -1px;
}`,html:"<my-tags></my-tags>"},pi={id:"css-custom-properties",title:"CSS Custom Properties",js:`import { Elena, html } from "@elenajs/core";
...
<my-button class="brand-theme">Brand Theme</my-button>`},fi={id:"baseline-support",title:"Baseline Support",js:`/** 
...
<baseline-support featureid="anchor-positioning"></baseline-support>`},hi={id:"mixins",title:"Mixins",js:`import { Elena, html } from "@elenajs/core";
...
</div>`},vi={id:"shadow-dom",title:"Shadow DOM",js:`import { Elena, html } from "@elenajs/core";
...
</html>`}function Pe(e,t){for(const n of e){const s=n.items.find(a=>a.id===t);if(s)return s}return null}function Me(){return typeof window>"u"?null:window.location.hash.slice(1)||null}function Ee(e){typeof window>"u"||history.replaceState(null,"","#"+e)}function Si(e,t){let n;return function(...s){clearTimeout(n),n=setTimeout(()=>e.apply(this,s),t)}}const _i={class:"pg-layout"},xi={class:"pg-main"},wi={__name:"PlaygroundWrapper",setup(e){const t=ve(null),n=S(!1),s=S(!1),a=S("");function r(p){const u=Pe(G,p);u&&(a.value=u.id,Ee(u.id),s.value=!1)}function l(){const p=Me();p&&p!==a.value&&r(p)}return z(async()=>{var y,w,P;const p=Me(),u=((w=(y=G[0])==null?void 0:y.items[0])==null?void 0:w.id)||"hello-world",k=Pe(G,p||u)||((P=G[0])==null?void 0:P.items[0]);a.value=(k==null?void 0:k.id)||"",p||Ee(a.value),window.addEventListener("hashchange",l);const L=await ge(()=>import("./Playground.CbaeH8od.js"),__vite__mapDeps([2,1]));t.value=L.default}),ne(()=>{window.removeEventListener("hashchange",l)}),(p,u)=>(o(),c("div",_i,[b(Ko,{examples:i(G),"current-id":a.value,open:s.value,onSelect:r,onToggle:u[0]||(u[0]=k=>s.value=!s.value)},null,8,["examples","current-id","open"]),m("div",xi,[(o(),g(B(t.value||Se),{"current-id":a.value,onPreviewReady:u[1]||(u[1]=k=>n.value=!0),onToggleSidebar:u[2]||(u[2]=k=>s.value=!s.value)},null,40,["current-id"])),b(ee,{name:"pg-unload"},{default:f(()=>[t.value&&!n.value?(o(),g(Se,{key:0,class:"pg-loading-overlay"})):h("",!0)]),_:1})])]))}},Pi={extends:Bo,setup(){Oo(K())},enhanceApp({app:e}){if(e.component("Playground",wi),typeof window<"u"){let t=!1;document.addEventListener("pointerenter",n=>{if(t)return;n.target.closest('a[href*="/playground"]')&&(t=!0,ge(()=>import("./Playground.CbaeH8od.js"),__vite__mapDeps([2,1])))},!0)}}};export{Pi as R,ba as c,Si as d,G as e,Pe as f,Li as g,$ as u};
