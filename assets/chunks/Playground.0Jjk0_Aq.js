...
import{o as y,c as g,j as r,n as w,F as M,B as T,t as A,a0 as z,u as q,q as C,v as _,x as B,G as F,p as v,V as x,E as j,k as W,ah as J}from"./framework.C4CIcs3_.js";const Y={id:"hello-world",title:"Hello World",js:`import { Elena, html } from "@elenajs/core";
...
MyGreeting.define();`,css:`@scope (my-greeting) {
  :scope {
    display: inline-block;
  }
}`,html:'<my-greeting name="Elena"></my-greeting>'},V={id:"composite-component",title:"Composite Component",js:`import { Elena } from "@elenajs/core";
...
<my-stack direction="row">
  ...
  <div>Second</div>
  <div>Third</div>
</my-stack>`},G={id:"primitive-component",title:"Primitive Component",js:`import { Elena, html } from "@elenajs/core";
...
<my-button variant="danger">Danger</my-button>`},K={id:"declarative-component",title:"Declarative Component",js:`import { Elena } from "@elenajs/core";
...
MyButton.define();`,css:`/* Styles are linked inside each <template> block.
...
<my-button>
  ...
  Cancel
</my-button>`},X={id:"string-props",title:"String Props",js:`import { Elena, html } from "@elenajs/core";
...
<my-checkbox disabled label="Disabled"></my-checkbox>`},Z={id:"number-props",title:"Number Props",js:`import { Elena, html } from "@elenajs/core";
...
<my-counter count="10" step="5" max="95"></my-counter>`},ee={id:"array-object-props",title:"Array/Object Props",js:`import { Elena, html } from "@elenajs/core";
...
></my-list>`},te={id:"conditional-rendering",title:"Conditional Rendering",js:`import { Elena, html, nothing } from "@elenajs/core";
...
<my-alert variant="warning" dismissible>This warning can be dismissed.</my-alert>`},se={id:"list-rendering",title:"List Rendering",js:`import { Elena, html } from "@elenajs/core";
...
}`,html:"<my-list></my-list>"},ne={id:"unsafe-html",title:"unsafeHTML",js:`import { Elena, html, unsafeHTML } from "@elenajs/core";
...
<my-icon name="check" style="color: #48bb78"></my-icon>`},oe={id:"element-ref",title:"Element Ref",js:`import { Elena, html } from "@elenajs/core";
...
input:focus {
  outline: 2px solid #3182ce;
  outline-offset: -1px;
}`,html:'<my-input label="Character counter"></my-input>'},ie={id:"delegated-events",title:"Delegated Events",js:`import { Elena, html } from "@elenajs/core";
...
<pre id="log"></pre>`},re={id:"custom-events",title:"Custom Events",js:`import { Elena, html } from "@elenajs/core";
...
<p id="output">Click a star to rate.</p>`},ae={id:"manual-listeners",title:"Manual Listeners",js:`import { Elena, html } from "@elenajs/core";
...
}`,html:"<my-key-logger></my-key-logger>"},le={id:"will-update",title:"willUpdate",js:`import { Elena, html } from "@elenajs/core";
...
input:focus {
  outline: 2px solid #3182ce;
  outline-offset: -1px;
}`,html:"<my-filter></my-filter>"},ce={id:"first-updated",title:"firstUpdated",js:`import { Elena, html } from "@elenajs/core";
...
MyAutofocus.define();`,css:`@scope (my-autofocus) {
  :scope,
  *:where(:not(img, svg):not(svg *)),
  *::before,
  *::after {
...
input:focus {
  outline: 2px solid #3182ce;
  outline-offset: -1px;
}`,html:"<my-autofocus></my-autofocus>"},de={id:"request-update",title:"requestUpdate",js:`import { Elena, html } from "@elenajs/core";
...
<my-button class="brand-theme">Brand Theme</my-button>`},ue={id:"mixins",title:"Mixins",js:`import { Elena, html } from "@elenajs/core";
...
</div>`},pe={id:"shadow-dom",title:"Shadow DOM",js:`import { Elena, html } from "@elenajs/core";
...
</html>`}function ve(l,o){for(const e of l){const t=e.items.find(c=>c.id===o);if(t)return t}return null}function P(){return typeof window>"u"?null:window.location.hash.slice(1)||null}function xe(l){typeof window>"u"||history.replaceState(null,"","#"+l)}function we(l,o){let e;return function(...t){clearTimeout(e),e=setTimeout(()=>l.apply(this,t),o)}}const ke={class:"pg-sidebar-nav"},Ee={class:"pg-sidebar-heading"},Me={class:"pg-sidebar-items"},Ce={class:"item"},Se=["href","onClick"],je={class:"text"},Le={__name:"PlaygroundSidebar",props:{examples:{type:Array,required:!0},currentId:{type:String,default:""},open:{type:Boolean,default:!1}},emits:["select","toggle"],setup(l,{emit:o}){const e=o;return(t,c)=>(y(),g(M,null,[r("div",{class:w(["pg-sidebar-backdrop",{open:l.open}]),onClick:c[0]||(c[0]=d=>e("toggle"))},null,2),r("aside",{class:w(["pg-sidebar",{open:l.open}])},[r("nav",ke,[(y(!0),g(M,null,T(l.examples,d=>(y(),g("div",{key:d.category,class:"pg-sidebar-group"},[r("p",Ee,A(d.category),1),r("div",Me,[(y(!0),g(M,null,T(d.items,s=>(y(),g("div",{key:s.id,class:w(["pg-sidebar-item",{"is-active":l.currentId===s.id}])},[r("div",Ce,[c[1]||(c[1]=r("div",{class:"indicator"},null,-1)),r("a",{class:"link",href:"#"+s.id,onClick:z(f=>e("select",s.id),["prevent"])},[r("p",je,A(s.title),1)],8,Se)])],2))),128))])]))),128))])],2)],64))}},Te={class:"pg-editor"},Ae={class:"pg-editor-tabs"},_e=["onClick"],$e={__name:"PlaygroundEditor",props:{js:{type:String,default:""},css:{type:String,default:""},html:{type:String,default:""},activeTab:{type:String,default:"js"}},emits:["update:js","update:css","update:html","update:activeTab","toggle-sidebar"],setup(l,{emit:o}){const e=l,t=o,{isDark:c}=q(),d=v(null),s=F(null),f=["js","css","html"];let n=null,b=null,u=null;function i(a){return a==="js"?e.js:a==="css"?e.css:e.html}function p(a){return a==="js"?"update:js":a==="css"?"update:css":"update:html"}async function U(){if(n)return n;const[a,m,h,k,E,S]=await Promise.all([x(()=>import("./index.D4PcRLKH.js"),__vite__mapDeps([0,1,2,3])),x(()=>import("./index.tqIctuLa.js"),[]),x(()=>import("./index.KpVkJyBP.js"),__vite__mapDeps([4,5,1,2,3])),x(()=>import("./index.BHg0SI1Q.js"),__vite__mapDeps([6,5,1,2,7,4,3])),x(()=>import("./index.iNtltN6x.js"),__vite__mapDeps([7,5,1,2])),x(()=>import("./index.DRciRTh7.js"),__vite__mapDeps([8,1,2]))]);return n={cm:a,cmState:m,langJs:h,langHtml:k,langCss:E,themeDark:S},n}function $(a){return n?a==="js"?n.langJs.javascript():a==="css"?n.langCss.css():n.langHtml.html():[]}function N(){return n?c.value?n.themeDark.oneDark:[]:[]}async function O(){const a=await U(),{EditorView:m,basicSetup:h}=a.cm,{EditorState:k,Compartment:E}=a.cmState;b=new E,u=new E;const S=i(e.activeTab),R=k.create({doc:S,extensions:[h,b.of($(e.activeTab)),u.of(N()),m.updateListener.of(H=>{H.docChanged&&t(p(e.activeTab),H.state.doc.toString())}),m.theme({"&":{height:"100%",fontSize:"13px"},".cm-scroller":{overflow:"auto",fontFamily:"ui-monospace, monospace"},".cm-content":{padding:"12px 0"},".cm-gutters":{border:"none"}})]});s.value&&s.value.destroy(),s.value=new m({state:R,parent:d.value})}function I(a){a!==e.activeTab&&t("update:activeTab",a)}function D(){if(!s.value)return;const a=i(e.activeTab),m=s.value.state.doc.toString();a!==m&&s.value.dispatch({changes:{from:0,to:s.value.state.doc.length,insert:a}})}return C(()=>e.activeTab,()=>{!s.value||!n||(D(),s.value.dispatch({effects:b.reconfigure($(e.activeTab))}))}),C([()=>e.js,()=>e.css,()=>e.html],D),C(c,()=>{!s.value||!u||s.value.dispatch({effects:u.reconfigure(N())})}),_(O),B(()=>{s.value&&s.value.destroy()}),(a,m)=>(y(),g("div",Te,[r("div",Ae,[r("button",{class:"pg-sidebar-toggle",onClick:m[0]||(m[0]=h=>t("toggle-sidebar")),"aria-label":"Toggle examples"},[...m[1]||(m[1]=[r("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none"},[r("path",{d:"M2 4h12M2 8h12M2 12h12",stroke:"currentColor","stroke-width":"1.5","stroke-linecap":"round"})],-1)])]),(y(),g(M,null,T(f,h=>r("button",{key:h,class:w(["pg-editor-tab",{active:l.activeTab===h}]),onClick:k=>I(h)},A(h.toUpperCase()),11,_e)),64))]),r("div",{ref_key:"editorContainer",ref:d,class:"pg-editor-container"},null,512)]))}},Ne={class:"pg-preview"},De=["srcdoc"],He={__name:"PlaygroundPreview",props:{js:{type:String,default:""},css:{type:String,default:""},html:{type:String,default:""}},setup(l){const o=l,e=v(null),t=v(null),c=v(!1);function d(){c.value=!1,t.value=be(o.js,o.css,o.html)}const s=we(d,300);return _(d),C([()=>o.js,()=>o.css,()=>o.html],(f,n)=>{n&&f[0]!==n[0]&&f[1]!==n[1]&&f[2]!==n[2]?d():s()}),(f,n)=>(y(),g("div",Ne,[r("div",{class:"pg-preview-header"},[n[1]||(n[1]=r("span",{class:"pg-preview-title"},"Preview",-1)),r("button",{class:"pg-preview-reload",onClick:d,title:"Reload preview"},[...n[0]||(n[0]=[r("svg",{width:"14",height:"14",viewBox:"0 0 16 16",fill:"none"},[r("path",{d:"M13.65 2.35A7.96 7.96 0 0 0 8 0C3.58 0 0 3.58 0 8s3.58 8 8 8c3.73 0 6.84-2.55 7.73-6h-2.08A5.99 5.99 0 0 1 8 14 6 6 0 1 1 8 2c1.66 0 3.14.69 4.22 1.78L9 7h7V0l-2.35 2.35z",fill:"currentColor"})],-1)])])]),r("iframe",{ref_key:"iframe",ref:e,class:w(["pg-preview-iframe",{"pg-preview-ready":c.value}]),srcdoc:t.value,sandbox:"allow-scripts",title:"Component preview"},null,10,De)]))}},Pe={class:"pg-layout"},Ue={__name:"Playground",setup(l){var n,b;const o=v(!1),e=v("js"),t=J({js:"",css:"",html:""}),c=v("");function d(u){const i=ve(L,u);i&&(c.value=i.id,t.js=i.js,t.css=i.css,t.html=i.html,e.value="js",xe(i.id),o.value=!1)}function s(){const u=P();u&&u!==c.value&&d(u)}const f=((b=(n=L[0])==null?void 0:n.items[0])==null?void 0:b.id)||"hello-world";return d(P()||f),_(()=>{window.addEventListener("hashchange",s)}),B(()=>{window.removeEventListener("hashchange",s)}),(u,i)=>(y(),g("div",Pe,[j(Le,{examples:W(L),"current-id":c.value,open:o.value,onSelect:d,onToggle:i[0]||(i[0]=p=>o.value=!o.value)},null,8,["examples","current-id","open"]),j($e,{js:t.js,css:t.css,html:t.html,"active-tab":e.value,"onUpdate:js":i[1]||(i[1]=p=>t.js=p),"onUpdate:css":i[2]||(i[2]=p=>t.css=p),"onUpdate:html":i[3]||(i[3]=p=>t.html=p),"onUpdate:activeTab":i[4]||(i[4]=p=>e.value=p),onToggleSidebar:i[5]||(i[5]=p=>o.value=!o.value)},null,8,["js","css","html","active-tab"]),j(He,{js:t.js,css:t.css,html:t.html},null,8,["js","css","html"])]))}};export{Ue as default};
