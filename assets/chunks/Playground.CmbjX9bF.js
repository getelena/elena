...
import{o as h,c as f,j as o,n as x,F as C,B as T,t as j,a0 as U,u as R,q as _,v as A,x as D,G as F,h as W,p as v,V as w,E as S,k as V,ah as Z}from"./framework.C4CIcs3_.js";const Y={id:"hello-world",title:"Hello World",js:`import { Elena, html } from "@elenajs/core";
...
MyGreeting.define();`,html:'<my-greeting name="Elena"></my-greeting>'},J={id:"composite-component",title:"Composite Component",js:`import { Elena } from "@elenajs/core";
...
<my-stack direction="row">
  ...
  <div>Second</div>
  <div>Third</div>
</my-stack>`},X={id:"primitive-component",title:"Primitive Component",js:`import { Elena, html } from "@elenajs/core";
...
<baseline-support featureid="anchor-positioning"></baseline-support>`},he={id:"mixins",title:"Mixins",js:`import { Elena, html } from "@elenajs/core";
...
</html>`}function xe(l,a){for(const e of l){const t=e.items.find(c=>c.id===a);if(t)return t}return null}function O(){return typeof window>"u"?null:window.location.hash.slice(1)||null}function ke(l){typeof window>"u"||history.replaceState(null,"","#"+l)}function Ee(l,a){let e;return function(...t){clearTimeout(e),e=setTimeout(()=>l.apply(this,t),a)}}const Ce={class:"pg-sidebar-nav"},_e={class:"pg-sidebar-heading"},Me={class:"pg-sidebar-items"},Se={class:"item"},Le=["href","onClick"],Te={class:"text"},je={__name:"PlaygroundSidebar",props:{examples:{type:Array,required:!0},currentId:{type:String,default:""},open:{type:Boolean,default:!1}},emits:["select","toggle"],setup(l,{emit:a}){const e=a;return(t,c)=>(h(),f(C,null,[o("div",{class:x(["pg-sidebar-backdrop",{open:l.open}]),onClick:c[0]||(c[0]=d=>e("toggle"))},null,2),o("aside",{class:x(["pg-sidebar",{open:l.open}])},[o("nav",Ce,[(h(!0),f(C,null,T(l.examples,d=>(h(),f("div",{key:d.category,class:"pg-sidebar-group"},[o("p",_e,j(d.category),1),o("div",Me,[(h(!0),f(C,null,T(d.items,s=>(h(),f("div",{key:s.id,class:x(["pg-sidebar-item",{"is-active":l.currentId===s.id}])},[o("div",Se,[c[1]||(c[1]=o("div",{class:"indicator"},null,-1)),o("a",{class:"link",href:"#"+s.id,onClick:U(b=>e("select",s.id),["prevent"])},[o("p",Te,j(s.title),1)],8,Le)])],2))),128))])]))),128))])],2)],64))}},Ae={class:"pg-editor"},Ne={class:"pg-editor-tabs"},ze=["onClick"],$e={__name:"PlaygroundEditor",props:{js:{type:String,default:""},css:{type:String,default:""},html:{type:String,default:""},activeTab:{type:String,default:"js"}},emits:["update:js","update:css","update:html","update:activeTab","toggle-sidebar"],setup(l,{emit:a}){const e=l,t=a,{isDark:c}=R(),d=v(null),s=F(null),b=W(()=>e.css?["js","css","html"]:["js","html"]);let n=null,g=null,m=null;function i(r){return r==="js"?e.js:r==="css"?e.css:e.html}function u(r){return r==="js"?"update:js":r==="css"?"update:css":"update:html"}async function H(){if(n)return n;const[r,p,y,k,E,M]=await Promise.all([w(()=>import("./index.D4PcRLKH.js"),__vite__mapDeps([0,1,2,3])),w(()=>import("./index.tqIctuLa.js"),[]),w(()=>import("./index.KpVkJyBP.js"),__vite__mapDeps([4,5,1,2,3])),w(()=>import("./index.BHg0SI1Q.js"),__vite__mapDeps([6,5,1,2,7,4,3])),w(()=>import("./index.iNtltN6x.js"),__vite__mapDeps([7,5,1,2])),w(()=>import("./index.DRciRTh7.js"),__vite__mapDeps([8,1,2]))]);return n={cm:r,cmState:p,langJs:y,langHtml:k,langCss:E,themeDark:M},n}function N(r){return n?r==="js"?n.langJs.javascript():r==="css"?n.langCss.css():n.langHtml.html():[]}function z(){return n?c.value?n.themeDark.oneDark:[]:[]}async function I(){const r=await H(),{EditorView:p,basicSetup:y}=r.cm,{EditorState:k,Compartment:E}=r.cmState;g=new E,m=new E;const M=i(e.activeTab),q=k.create({doc:M,extensions:[y,g.of(N(e.activeTab)),m.of(z()),p.updateListener.of(B=>{B.docChanged&&t(u(e.activeTab),B.state.doc.toString())}),p.theme({"&":{height:"100%",fontSize:"13px"},".cm-scroller":{overflow:"auto",fontFamily:"ui-monospace, monospace"},".cm-content":{padding:"12px 0"},".cm-gutters":{border:"none"}})]});s.value&&s.value.destroy(),s.value=new p({state:q,parent:d.value})}function P(r){r!==e.activeTab&&t("update:activeTab",r)}function $(){if(!s.value)return;const r=i(e.activeTab),p=s.value.state.doc.toString();r!==p&&s.value.dispatch({changes:{from:0,to:s.value.state.doc.length,insert:r}})}return _(()=>e.activeTab,()=>{!s.value||!n||($(),s.value.dispatch({effects:g.reconfigure(N(e.activeTab))}))}),_([()=>e.js,()=>e.css,()=>e.html],$),_(c,()=>{!s.value||!m||s.value.dispatch({effects:m.reconfigure(z())})}),A(I),D(()=>{s.value&&s.value.destroy()}),(r,p)=>(h(),f("div",Ae,[o("div",Ne,[o("button",{class:"pg-sidebar-toggle",onClick:p[0]||(p[0]=y=>t("toggle-sidebar")),"aria-label":"Toggle examples"},[...p[1]||(p[1]=[o("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none"},[o("path",{d:"M2 4h12M2 8h12M2 12h12",stroke:"currentColor","stroke-width":"1.5","stroke-linecap":"round"})],-1)])]),(h(!0),f(C,null,T(b.value,y=>(h(),f("button",{key:y,class:x(["pg-editor-tab",{active:l.activeTab===y}]),onClick:k=>P(y)},j(y.toUpperCase()),11,ze))),128))]),o("div",{ref_key:"editorContainer",ref:d,class:"pg-editor-container"},null,512)]))}},Be={class:"pg-preview"},Oe=["srcdoc"],De={__name:"PlaygroundPreview",props:{js:{type:String,default:""},css:{type:String,default:""},html:{type:String,default:""}},setup(l){const a=l,e=v(null),t=v(null),c=v(!1);function d(){c.value=!1,t.value=we(a.js,a.css,a.html)}const s=Ee(d,300);return A(d),_([()=>a.js,()=>a.css,()=>a.html],(b,n)=>{n&&b[0]!==n[0]&&b[1]!==n[1]&&b[2]!==n[2]?d():s()}),(b,n)=>(h(),f("div",Be,[o("div",{class:"pg-preview-header"},[n[1]||(n[1]=o("span",{class:"pg-preview-title"},"Preview",-1)),o("button",{class:"pg-preview-reload",onClick:d,title:"Reload preview"},[...n[0]||(n[0]=[o("svg",{width:"14",height:"14",viewBox:"0 0 16 16",fill:"none"},[o("path",{d:"M13.65 2.35A7.96 7.96 0 0 0 8 0C3.58 0 0 3.58 0 8s3.58 8 8 8c3.73 0 6.84-2.55 7.73-6h-2.08A5.99 5.99 0 0 1 8 14 6 6 0 1 1 8 2c1.66 0 3.14.69 4.22 1.78L9 7h7V0l-2.35 2.35z",fill:"currentColor"})],-1)])])]),o("iframe",{ref_key:"iframe",ref:e,class:x(["pg-preview-iframe",{"pg-preview-ready":c.value}]),srcdoc:t.value,sandbox:"allow-scripts allow-same-origin",title:"Component preview"},null,10,Oe)]))}},He={class:"pg-layout"},Pe={__name:"Playground",setup(l){var n,g;const a=v(!1),e=v("js"),t=Z({js:"",css:"",html:""}),c=v("");function d(m){const i=xe(L,m);i&&(c.value=i.id,t.js=i.js,t.css=i.css,t.html=i.html,e.value="js",ke(i.id),a.value=!1)}function s(){const m=O();m&&m!==c.value&&d(m)}const b=((g=(n=L[0])==null?void 0:n.items[0])==null?void 0:g.id)||"hello-world";return A(()=>{d(O()||b),window.addEventListener("hashchange",s)}),D(()=>{window.removeEventListener("hashchange",s)}),(m,i)=>(h(),f("div",He,[S(je,{examples:V(L),"current-id":c.value,open:a.value,onSelect:d,onToggle:i[0]||(i[0]=u=>a.value=!a.value)},null,8,["examples","current-id","open"]),S($e,{js:t.js,css:t.css,html:t.html,"active-tab":e.value,"onUpdate:js":i[1]||(i[1]=u=>t.js=u),"onUpdate:css":i[2]||(i[2]=u=>t.css=u),"onUpdate:html":i[3]||(i[3]=u=>t.html=u),"onUpdate:activeTab":i[4]||(i[4]=u=>e.value=u),onToggleSidebar:i[5]||(i[5]=u=>a.value=!a.value)},null,8,["js","css","html","active-tab"]),S(De,{js:t.js,css:t.css,html:t.html},null,8,["js","css","html"])]))}};export{Pe as default};
