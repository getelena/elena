const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/Playground.CK_6wyu2.js","assets/chunks/framework.BuHTiEMl.js"])))=>i.map(i=>d[i]);
import{_ as q,o as d,c as p,ae as U,j as l,n as w,F as E,z,t as $,Z as F,v as W,x as V,C as A,k as J,b as j,E as Z,e as C,w as Y,T as X,L as K,p as h,S as O,D as G,h as Q}from"./framework.BuHTiEMl.js";const ee={},te={class:"pg-loading-skeleton"};function se(e,t){return d(),p("div",te,[...t[0]||(t[0]=[U('<div class="pg-editor pg-editor-loading"><div class="pg-editor-tabs"><button class="pg-editor-tab active">HTML</button><button class="pg-editor-tab">CSS</button><button class="pg-editor-tab">JS</button></div><div class="pg-editor-container"></div></div><div class="pg-preview"><div class="pg-preview-header"><span class="pg-preview-title">Preview</span></div><div class="pg-preview-iframe"></div></div>',2)])])}const B=q(ee,[["render",se]]),ne={class:"pg-sidebar-nav"},ae={class:"pg-sidebar-heading"},ie={class:"pg-sidebar-items"},oe={class:"item"},re=["href","onClick"],le={class:"text"},ce={__name:"PlaygroundSidebar",props:{examples:{type:Array,required:!0},currentId:{type:String,default:""},open:{type:Boolean,default:!1}},emits:["select","toggle"],setup(e,{emit:t}){const s=t;return(o,n)=>(d(),p(E,null,[l("div",{class:w(["pg-sidebar-backdrop",{open:e.open}]),onClick:n[0]||(n[0]=r=>s("toggle"))},null,2),l("aside",{class:w(["pg-sidebar",{open:e.open}])},[l("nav",ne,[(d(!0),p(E,null,z(e.examples,r=>(d(),p("div",{key:r.category,class:"pg-sidebar-group"},[l("p",ae,$(r.category),1),l("div",ie,[(d(!0),p(E,null,z(r.items,c=>(d(),p("div",{key:c.id,class:w(["pg-sidebar-item",{"is-active":e.currentId===c.id}])},[l("div",oe,[n[1]||(n[1]=l("div",{class:"indicator"},null,-1)),l("a",{class:"link",href:"#"+c.id,onClick:F(u=>s("select",c.id),["prevent"])},[l("p",le,$(c.title),1)],8,re)])],2))),128))])]))),128))])],2)],64))}},de={id:"hello-world",title:"Hello World",js:`import { Elena, html } from "@elenajs/core";
...
`,I=$e.replace(/\/\/# sourceMappingURL=.*$/m,"").trim(),Ae=typeof Blob<"u"?URL.createObjectURL(new Blob([I],{type:"text/javascript"})):`data:text/javascript;charset=utf-8,${encodeURIComponent(I)}`,je=JSON.stringify({imports:{"@elenajs/core":Ae}});function He(e,t,s){return`<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
