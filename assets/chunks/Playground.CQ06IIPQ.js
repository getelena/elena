...
import{o as y,c as g,j as i,n as M,F as j,B as $,t as B,a0 as V,u as Z,V as E,q as A,v as U,x as R,G as Y,h as J,p as k,ah as X,E as z,k as K}from"./framework.lVAEw_NY.js";const G={id:"hello-world",title:"Hello World",js:`import { Elena, html } from "@elenajs/core";
...
MyGreeting.define();`,html:'<my-greeting name="Elena"></my-greeting>'},Q={id:"composite-component",title:"Composite Component",js:`import { Elena } from "@elenajs/core";
...
<my-stack direction="row">
  ...
  <div>Second</div>
  <div>Third</div>
</my-stack>`},ee={id:"primitive-component",title:"Primitive Component",js:`import { Elena, html } from "@elenajs/core";
...
<my-button variant="danger">Danger</my-button>`},te={id:"declarative-component",title:"Declarative Component",js:`import { Elena } from "@elenajs/core";
...
<my-button>
  ...
  Cancel
</my-button>`},se={id:"string-props",title:"String Props",js:`import { Elena, html } from "@elenajs/core";
...
<my-badge variant="error">Error</my-badge>`},ne={id:"boolean-props",title:"Boolean Props",js:`import { Elena, html } from "@elenajs/core";
...
<my-checkbox disabled label="Disabled"></my-checkbox>`},ae={id:"number-props",title:"Number Props",js:`import { Elena, html } from "@elenajs/core";
...
<my-counter count="10" step="5" max="95"></my-counter>`},ie={id:"array-object-props",title:"Array/Object Props",js:`import { Elena, html } from "@elenajs/core";
...
></my-list>`},re={id:"conditional-rendering",title:"Conditional Rendering",js:`import { Elena, html, nothing } from "@elenajs/core";
...
<my-alert variant="warning" dismissible>This warning can be dismissed.</my-alert>`},oe={id:"list-rendering",title:"List Rendering",js:`import { Elena, html } from "@elenajs/core";
...
}`,html:"<my-list></my-list>"},le={id:"unsafe-html",title:"unsafeHTML",js:`import { Elena, html, unsafeHTML } from "@elenajs/core";
...
<my-icon name="check" style="color: #48bb78"></my-icon>`},ce={id:"element-ref",title:"Element Ref",js:`import { Elena, html } from "@elenajs/core";
...
my-input input:focus {
  outline: 2px solid #5a44d4;
  outline-offset: -1px;
}`,html:'<my-input label="Character counter"></my-input>'},de={id:"delegated-events",title:"Delegated Events",js:`import { Elena, html } from "@elenajs/core";
...
<pre id="log"></pre>`},pe={id:"custom-events",title:"Custom Events",js:`import { Elena, html } from "@elenajs/core";
...
<p id="output">Click a star to rate.</p>`},me={id:"manual-listeners",title:"Manual Listeners",js:`import { Elena, html } from "@elenajs/core";
...
}`,html:"<my-key-logger></my-key-logger>"},ue={id:"will-update",title:"willUpdate",js:`import { Elena, html } from "@elenajs/core";
...
my-filter input:focus {
  outline: 2px solid #5a44d4;
  outline-offset: -1px;
}`,html:"<my-filter></my-filter>"},he={id:"first-updated",title:"firstUpdated",js:`import { Elena, html } from "@elenajs/core";
...
}`,html:"<my-card></my-card>"},fe={id:"request-update",title:"requestUpdate",js:`import { Elena, html } from "@elenajs/core";
...
my-tags input:focus {
  outline: 2px solid #5a44d4;
  outline-offset: -1px;
}`,html:"<my-tags></my-tags>"},be={id:"css-custom-properties",title:"CSS Custom Properties",js:`import { Elena, html } from "@elenajs/core";
...
<my-button class="brand-theme">Brand Theme</my-button>`},ye={id:"baseline-support",title:"Baseline Support",js:`/** 
...
<baseline-support featureid="anchor-positioning"></baseline-support>`},ge={id:"mixins",title:"Mixins",js:`import { Elena, html } from "@elenajs/core";
...
</div>`},ve={id:"shadow-dom",title:"Shadow DOM",js:`import { Elena, html } from "@elenajs/core";
...
</html>`}function I(r,m){for(const e of r){const o=e.items.find(d=>d.id===m);if(o)return o}return null}function P(){return typeof window>"u"?null:window.location.hash.slice(1)||null}function q(r){typeof window>"u"||history.replaceState(null,"","#"+r)}function Ce(r,m){let e;return function(...o){clearTimeout(e),e=setTimeout(()=>r.apply(this,o),m)}}const _e={class:"pg-sidebar-nav"},Me={class:"pg-sidebar-heading"},Se={class:"pg-sidebar-items"},Le={class:"item"},Te=["href","onClick"],je={class:"text"},Ae={__name:"PlaygroundSidebar",props:{examples:{type:Array,required:!0},currentId:{type:String,default:""},open:{type:Boolean,default:!1}},emits:["select","toggle"],setup(r,{emit:m}){const e=m;return(o,d)=>(y(),g(j,null,[i("div",{class:M(["pg-sidebar-backdrop",{open:r.open}]),onClick:d[0]||(d[0]=u=>e("toggle"))},null,2),i("aside",{class:M(["pg-sidebar",{open:r.open}])},[i("nav",_e,[(y(!0),g(j,null,$(r.examples,u=>(y(),g("div",{key:u.category,class:"pg-sidebar-group"},[i("p",Me,B(u.category),1),i("div",Se,[(y(!0),g(j,null,$(u.items,t=>(y(),g("div",{key:t.id,class:M(["pg-sidebar-item",{"is-active":r.currentId===t.id}])},[i("div",Le,[d[1]||(d[1]=i("div",{class:"indicator"},null,-1)),i("a",{class:"link",href:"#"+t.id,onClick:V(l=>e("select",t.id),["prevent"])},[i("p",je,B(t.title),1)],8,Te)])],2))),128))])]))),128))])],2)],64))}},Ne={class:"pg-editor"},ze={class:"pg-editor-tabs"},$e=["onClick"],Be={__name:"PlaygroundEditor",props:{js:{type:String,default:""},css:{type:String,default:""},html:{type:String,default:""},activeTab:{type:String,default:"js"}},emits:["update:js","update:css","update:html","update:activeTab","toggle-sidebar"],setup(r,{emit:m}){const e=r,o=m,{isDark:d}=Z(),u=k(null),t=Y(null),l=J(()=>e.css?["js","css","html"]:["js","html"]),c=typeof window<"u"?Promise.all([E(()=>import("./index.D4PcRLKH.js"),__vite__mapDeps([0,1,2,3])),E(()=>import("./index.tqIctuLa.js"),[]),E(()=>import("./index.KpVkJyBP.js"),__vite__mapDeps([4,5,1,2,3])),E(()=>import("./index.BHg0SI1Q.js"),__vite__mapDeps([6,5,1,2,7,4,3])),E(()=>import("./index.iNtltN6x.js"),__vite__mapDeps([7,5,1,2])),E(()=>import("./index.DRciRTh7.js"),__vite__mapDeps([8,1,2]))]):null;let n=null,x=null,h=null;function p(a){return a==="js"?e.js:a==="css"?e.css:e.html}function C(a){return a==="js"?"update:js":a==="css"?"update:css":"update:html"}async function S(){if(n)return n;const[a,b,w,L,T,N]=await c;return n={cm:a,cmState:b,langJs:w,langHtml:L,langCss:T,themeDark:N},n}function v(a){return n?a==="js"?n.langJs.javascript():a==="css"?n.langCss.css():n.langHtml.html():[]}function s(){return n?d.value?n.themeDark.oneDark:[]:[]}async function f(){const a=await S(),{EditorView:b,basicSetup:w}=a.cm,{EditorState:L,Compartment:T}=a.cmState;x=new T,h=new T;const N=p(e.activeTab),W=L.create({doc:N,extensions:[w,x.of(v(e.activeTab)),h.of(s()),b.updateListener.of(D=>{D.docChanged&&o(C(e.activeTab),D.state.doc.toString())}),b.theme({"&":{height:"100%",fontSize:"13px"},".cm-scroller":{overflow:"auto",fontFamily:"ui-monospace, monospace"},".cm-content":{padding:"12px 0"},".cm-gutters":{border:"none"}})]});t.value&&t.value.destroy(),t.value=new b({state:W,parent:u.value})}function F(a){a!==e.activeTab&&o("update:activeTab",a)}function O(){if(!t.value)return;const a=p(e.activeTab),b=t.value.state.doc.toString();a!==b&&t.value.dispatch({changes:{from:0,to:t.value.state.doc.length,insert:a}})}return A(()=>e.activeTab,()=>{!t.value||!n||(O(),t.value.dispatch({effects:x.reconfigure(v(e.activeTab))}))}),A([()=>e.js,()=>e.css,()=>e.html],O),A(d,()=>{!t.value||!h||t.value.dispatch({effects:h.reconfigure(s())})}),U(f),R(()=>{t.value&&t.value.destroy()}),(a,b)=>(y(),g("div",Ne,[i("div",ze,[i("button",{class:"pg-sidebar-toggle",onClick:b[0]||(b[0]=w=>o("toggle-sidebar")),"aria-label":"Toggle examples"},[...b[1]||(b[1]=[i("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none"},[i("path",{d:"M2 4h12M2 8h12M2 12h12",stroke:"currentColor","stroke-width":"1.5","stroke-linecap":"round"})],-1)])]),(y(!0),g(j,null,$(l.value,w=>(y(),g("button",{key:w,class:M(["pg-editor-tab",{active:r.activeTab===w}]),onClick:L=>F(w)},B(w.toUpperCase()),11,$e))),128))]),i("div",{ref_key:"editorContainer",ref:u,class:"pg-editor-container"},null,512)]))}},Oe={class:"pg-preview"},De=["srcdoc"],He={__name:"PlaygroundPreview",props:{js:{type:String,default:""},css:{type:String,default:""},html:{type:String,default:""}},emits:["preview-ready"],setup(r,{emit:m}){const e=r,o=m,d=k(null),u=k(H(e.js,e.css,e.html)),t=k(!1);let l=!0;function c(){t.value=!0,l&&(l=!1,o("preview-ready"))}function n(){t.value=!1,u.value=H(e.js,e.css,e.html)}const x=Ce(n,300);return A([()=>e.js,()=>e.css,()=>e.html],(h,p)=>{p&&h[0]!==p[0]&&h[1]!==p[1]&&h[2]!==p[2]?n():x()}),(h,p)=>(y(),g("div",Oe,[i("div",{class:"pg-preview-header"},[p[1]||(p[1]=i("span",{class:"pg-preview-title"},"Preview",-1)),i("button",{class:"pg-preview-reload",onClick:n,title:"Reload preview"},[...p[0]||(p[0]=[i("svg",{width:"14",height:"14",viewBox:"0 0 16 16",fill:"none"},[i("path",{d:"M13.65 2.35A7.96 7.96 0 0 0 8 0C3.58 0 0 3.58 0 8s3.58 8 8 8c3.73 0 6.84-2.55 7.73-6h-2.08A5.99 5.99 0 0 1 8 14 6 6 0 1 1 8 2c1.66 0 3.14.69 4.22 1.78L9 7h7V0l-2.35 2.35z",fill:"currentColor"})],-1)])])]),i("iframe",{ref_key:"iframe",ref:d,class:M(["pg-preview-iframe",{"pg-preview-ready":t.value}]),srcdoc:u.value,sandbox:"allow-scripts allow-same-origin",title:"Component preview",onLoad:c},null,42,De)]))}},Ie={class:"pg-layout"},qe={__name:"Playground",emits:["preview-ready"],setup(r,{emit:m}){var p,C,S;const e=m,o=k(!1),d=k("js"),u=P(),t=((C=(p=_[0])==null?void 0:p.items[0])==null?void 0:C.id)||"hello-world",l=I(_,u||t)||((S=_[0])==null?void 0:S.items[0]),c=X({js:(l==null?void 0:l.js)||"",css:(l==null?void 0:l.css)||"",html:(l==null?void 0:l.html)||""}),n=k((l==null?void 0:l.id)||"");function x(v){const s=I(_,v);s&&(n.value=s.id,c.js=s.js,c.css=s.css,c.html=s.html,d.value="js",q(s.id),o.value=!1)}function h(){const v=P();v&&v!==n.value&&x(v)}return U(()=>{u||q(n.value),window.addEventListener("hashchange",h)}),R(()=>{window.removeEventListener("hashchange",h)}),(v,s)=>(y(),g("div",Ie,[z(Ae,{examples:K(_),"current-id":n.value,open:o.value,onSelect:x,onToggle:s[0]||(s[0]=f=>o.value=!o.value)},null,8,["examples","current-id","open"]),z(Be,{js:c.js,css:c.css,html:c.html,"active-tab":d.value,"onUpdate:js":s[1]||(s[1]=f=>c.js=f),"onUpdate:css":s[2]||(s[2]=f=>c.css=f),"onUpdate:html":s[3]||(s[3]=f=>c.html=f),"onUpdate:activeTab":s[4]||(s[4]=f=>d.value=f),onToggleSidebar:s[5]||(s[5]=f=>o.value=!o.value)},null,8,["js","css","html","active-tab"]),z(He,{js:c.js,css:c.css,html:c.html,onPreviewReady:s[6]||(s[6]=f=>e("preview-ready"))},null,8,["js","css","html"])]))}};export{qe as default};
