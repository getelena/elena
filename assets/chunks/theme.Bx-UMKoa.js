...
</html>`}function Me(e,t){for(const n of e){const s=n.items.find(a=>a.id===t);if(s)return s}return null}function Pe(){return typeof window>"u"?null:window.location.hash.slice(1)||null}function Ee(e){typeof window>"u"||history.replaceState(null,"","#"+e)}function Si(e,t){let n;return function(...s){clearTimeout(n),n=setTimeout(()=>e.apply(this,s),t)}}const xi={class:"pg-layout"},wi={__name:"PlaygroundWrapper",setup(e){const t=ve(null),n=S(!1),s=S(!1),a=S(""),r=S(null),l=S(null),m=S(!1),p=x(()=>l.value==null?{}:{gridTemplateColumns:`${l.value}px 0px 1fr`});function _(M){M.preventDefault(),m.value=!0,document.addEventListener("pointermove",L),document.addEventListener("pointerup",y)}function L(M){if(!r.value)return;const C=r.value.getBoundingClientRect(),A=200,B=C.width-200;l.value=Math.min(B,Math.max(A,M.clientX-C.left))}function y(){m.value=!1,document.removeEventListener("pointermove",L),document.removeEventListener("pointerup",y)}function w(M){const C=Me(J,M);C&&(a.value=C.id,Ee(C.id),s.value=!1)}function P(){const M=Pe();M&&M!==a.value&&w(M)}function V(){l.value=null}return D(async()=>{var j,G,K;window.addEventListener("resize",V);const M=Pe(),C=((G=(j=J[0])==null?void 0:j.items[0])==null?void 0:G.id)||"primitive-component",A=Me(J,M||C)||((K=J[0])==null?void 0:K.items[0]);a.value=(A==null?void 0:A.id)||"",M||Ee(a.value),window.addEventListener("hashchange",P);const B=await Ne(()=>import("./Playground.q1SCcrwz.js"),__vite__mapDeps([2,1]));t.value=B.default}),ae(()=>{window.removeEventListener("resize",V),window.removeEventListener("hashchange",P),document.removeEventListener("pointermove",L),document.removeEventListener("pointerup",y)}),(M,C)=>(o(),c("div",xi,[b(Jo,{examples:i(J),"current-id":a.value,open:s.value,onSelect:w,onToggle:C[0]||(C[0]=A=>s.value=!s.value)},null,8,["examples","current-id","open"]),u("div",{ref_key:"mainRef",ref:r,class:E(["pg-main",{"pg-resizing":m.value}]),style:be(p.value)},[(o(),g(H(t.value||Se),{"current-id":a.value,onPreviewReady:C[1]||(C[1]=A=>n.value=!0),onToggleSidebar:C[2]||(C[2]=A=>s.value=!s.value)},null,40,["current-id"])),n.value?(o(),c("div",{key:0,class:"pg-resize-handle",onPointerdown:_},null,32)):h("",!0),b(ne,{name:"pg-unload"},{default:f(()=>[t.value&&!n.value?(o(),g(Se,{key:0,class:"pg-loading-overlay"})):h("",!0)]),_:1})],6)]))}},Mi={extends:Bo,setup(){zo(Y())},enhanceApp({app:e}){e.component("Playground",wi)}};export{Mi as R,ba as c,Si as d,J as e,Me as f,Li as g,$ as u};
