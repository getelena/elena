...
import{o as h,c as f,j as a,n as w,F as C,B as L,t as N,a0 as R,u as F,q as M,v as _,x as B,G as q,h as W,p as v,V as x,E as S,k as J,ah as Y}from"./framework.C4CIcs3_.js";const V={id:"hello-world",title:"Hello World",js:`import { Elena, html } from "@elenajs/core";
...
</div>`},he={id:"shadow-dom",title:"Shadow DOM",js:`import { Elena, html } from "@elenajs/core";
...
</html>`}function xe(l,r){for(const e of l){const t=e.items.find(c=>c.id===r);if(t)return t}return null}function H(){return typeof window>"u"?null:window.location.hash.slice(1)||null}function we(l){typeof window>"u"||history.replaceState(null,"","#"+l)}function ke(l,r){let e;return function(...t){clearTimeout(e),e=setTimeout(()=>l.apply(this,t),r)}}const Ee={class:"pg-sidebar-nav"},Ce={class:"pg-sidebar-heading"},Me={class:"pg-sidebar-items"},je={class:"item"},Se=["href","onClick"],Te={class:"text"},Le={__name:"PlaygroundSidebar",props:{examples:{type:Array,required:!0},currentId:{type:String,default:""},open:{type:Boolean,default:!1}},emits:["select","toggle"],setup(l,{emit:r}){const e=r;return(t,c)=>(h(),f(C,null,[a("div",{class:w(["pg-sidebar-backdrop",{open:l.open}]),onClick:c[0]||(c[0]=d=>e("toggle"))},null,2),a("aside",{class:w(["pg-sidebar",{open:l.open}])},[a("nav",Ee,[(h(!0),f(C,null,L(l.examples,d=>(h(),f("div",{key:d.category,class:"pg-sidebar-group"},[a("p",Ce,N(d.category),1),a("div",Me,[(h(!0),f(C,null,L(d.items,s=>(h(),f("div",{key:s.id,class:w(["pg-sidebar-item",{"is-active":l.currentId===s.id}])},[a("div",je,[c[1]||(c[1]=a("div",{class:"indicator"},null,-1)),a("a",{class:"link",href:"#"+s.id,onClick:R(y=>e("select",s.id),["prevent"])},[a("p",Te,N(s.title),1)],8,Se)])],2))),128))])]))),128))])],2)],64))}},Ne={class:"pg-editor"},_e={class:"pg-editor-tabs"},Ae=["onClick"],$e={__name:"PlaygroundEditor",props:{js:{type:String,default:""},css:{type:String,default:""},html:{type:String,default:""},activeTab:{type:String,default:"js"}},emits:["update:js","update:css","update:html","update:activeTab","toggle-sidebar"],setup(l,{emit:r}){const e=l,t=r,{isDark:c}=F(),d=v(null),s=q(null),y=W(()=>e.css?["js","css","html"]:["js","html"]);let n=null,b=null,u=null;function o(i){return i==="js"?e.js:i==="css"?e.css:e.html}function p(i){return i==="js"?"update:js":i==="css"?"update:css":"update:html"}async function U(){if(n)return n;const[i,m,g,k,E,j]=await Promise.all([x(()=>import("./index.D4PcRLKH.js"),__vite__mapDeps([0,1,2,3])),x(()=>import("./index.tqIctuLa.js"),[]),x(()=>import("./index.KpVkJyBP.js"),__vite__mapDeps([4,5,1,2,3])),x(()=>import("./index.BHg0SI1Q.js"),__vite__mapDeps([6,5,1,2,7,4,3])),x(()=>import("./index.iNtltN6x.js"),__vite__mapDeps([7,5,1,2])),x(()=>import("./index.DRciRTh7.js"),__vite__mapDeps([8,1,2]))]);return n={cm:i,cmState:m,langJs:g,langHtml:k,langCss:E,themeDark:j},n}function A(i){return n?i==="js"?n.langJs.javascript():i==="css"?n.langCss.css():n.langHtml.html():[]}function $(){return n?c.value?n.themeDark.oneDark:[]:[]}async function O(){const i=await U(),{EditorView:m,basicSetup:g}=i.cm,{EditorState:k,Compartment:E}=i.cmState;b=new E,u=new E;const j=o(e.activeTab),I=k.create({doc:j,extensions:[g,b.of(A(e.activeTab)),u.of($()),m.updateListener.of(P=>{P.docChanged&&t(p(e.activeTab),P.state.doc.toString())}),m.theme({"&":{height:"100%",fontSize:"13px"},".cm-scroller":{overflow:"auto",fontFamily:"ui-monospace, monospace"},".cm-content":{padding:"12px 0"},".cm-gutters":{border:"none"}})]});s.value&&s.value.destroy(),s.value=new m({state:I,parent:d.value})}function z(i){i!==e.activeTab&&t("update:activeTab",i)}function D(){if(!s.value)return;const i=o(e.activeTab),m=s.value.state.doc.toString();i!==m&&s.value.dispatch({changes:{from:0,to:s.value.state.doc.length,insert:i}})}return M(()=>e.activeTab,()=>{!s.value||!n||(D(),s.value.dispatch({effects:b.reconfigure(A(e.activeTab))}))}),M([()=>e.js,()=>e.css,()=>e.html],D),M(c,()=>{!s.value||!u||s.value.dispatch({effects:u.reconfigure($())})}),_(O),B(()=>{s.value&&s.value.destroy()}),(i,m)=>(h(),f("div",Ne,[a("div",_e,[a("button",{class:"pg-sidebar-toggle",onClick:m[0]||(m[0]=g=>t("toggle-sidebar")),"aria-label":"Toggle examples"},[...m[1]||(m[1]=[a("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none"},[a("path",{d:"M2 4h12M2 8h12M2 12h12",stroke:"currentColor","stroke-width":"1.5","stroke-linecap":"round"})],-1)])]),(h(!0),f(C,null,L(y.value,g=>(h(),f("button",{key:g,class:w(["pg-editor-tab",{active:l.activeTab===g}]),onClick:k=>z(g)},N(g.toUpperCase()),11,Ae))),128))]),a("div",{ref_key:"editorContainer",ref:d,class:"pg-editor-container"},null,512)]))}},De={class:"pg-preview"},Pe=["srcdoc"],He={__name:"PlaygroundPreview",props:{js:{type:String,default:""},css:{type:String,default:""},html:{type:String,default:""}},setup(l){const r=l,e=v(null),t=v(null),c=v(!1);function d(){c.value=!1,t.value=ve(r.js,r.css,r.html)}const s=ke(d,300);return _(d),M([()=>r.js,()=>r.css,()=>r.html],(y,n)=>{n&&y[0]!==n[0]&&y[1]!==n[1]&&y[2]!==n[2]?d():s()}),(y,n)=>(h(),f("div",De,[a("div",{class:"pg-preview-header"},[n[1]||(n[1]=a("span",{class:"pg-preview-title"},"Preview",-1)),a("button",{class:"pg-preview-reload",onClick:d,title:"Reload preview"},[...n[0]||(n[0]=[a("svg",{width:"14",height:"14",viewBox:"0 0 16 16",fill:"none"},[a("path",{d:"M13.65 2.35A7.96 7.96 0 0 0 8 0C3.58 0 0 3.58 0 8s3.58 8 8 8c3.73 0 6.84-2.55 7.73-6h-2.08A5.99 5.99 0 0 1 8 14 6 6 0 1 1 8 2c1.66 0 3.14.69 4.22 1.78L9 7h7V0l-2.35 2.35z",fill:"currentColor"})],-1)])])]),a("iframe",{ref_key:"iframe",ref:e,class:w(["pg-preview-iframe",{"pg-preview-ready":c.value}]),srcdoc:t.value,sandbox:"allow-scripts",title:"Component preview"},null,10,Pe)]))}},Be={class:"pg-layout"},Oe={__name:"Playground",setup(l){var n,b;const r=v(!1),e=v("js"),t=Y({js:"",css:"",html:""}),c=v("");function d(u){const o=xe(T,u);o&&(c.value=o.id,t.js=o.js,t.css=o.css,t.html=o.html,e.value="js",we(o.id),r.value=!1)}function s(){const u=H();u&&u!==c.value&&d(u)}const y=((b=(n=T[0])==null?void 0:n.items[0])==null?void 0:b.id)||"hello-world";return d(H()||y),_(()=>{window.addEventListener("hashchange",s)}),B(()=>{window.removeEventListener("hashchange",s)}),(u,o)=>(h(),f("div",Be,[S(Le,{examples:J(T),"current-id":c.value,open:r.value,onSelect:d,onToggle:o[0]||(o[0]=p=>r.value=!r.value)},null,8,["examples","current-id","open"]),S($e,{js:t.js,css:t.css,html:t.html,"active-tab":e.value,"onUpdate:js":o[1]||(o[1]=p=>t.js=p),"onUpdate:css":o[2]||(o[2]=p=>t.css=p),"onUpdate:html":o[3]||(o[3]=p=>t.html=p),"onUpdate:activeTab":o[4]||(o[4]=p=>e.value=p),onToggleSidebar:o[5]||(o[5]=p=>r.value=!r.value)},null,8,["js","css","html","active-tab"]),S(He,{js:t.js,css:t.css,html:t.html},null,8,["js","css","html"])]))}};export{Oe as default};
