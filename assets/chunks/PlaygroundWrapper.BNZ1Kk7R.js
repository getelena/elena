const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/Playground.BjGnVO9E.js","assets/chunks/framework.D73iOW4a.js"])))=>i.map(i=>d[i]);
import{_ as q,o as d,c as p,ag as U,j as l,n as w,F as E,B as z,t as $,a0 as F,v as W,x as V,E as A,k as J,b as j,H as Z,e as C,w as Y,T as X,N as K,p as h,V as O,G,h as Q}from"./framework.D73iOW4a.js";const ee={},te={class:"pg-loading-skeleton"};function se(e,t){return d(),p("div",te,[...t[0]||(t[0]=[U('<div class="pg-editor pg-editor-loading"><div class="pg-editor-tabs"><button class="pg-editor-tab active">HTML</button><button class="pg-editor-tab">CSS</button><button class="pg-editor-tab">JS</button></div><div class="pg-editor-container"></div></div><div class="pg-preview"><div class="pg-preview-header"><span class="pg-preview-title">Preview</span></div><div class="pg-preview-iframe"></div></div>',2)])])}const B=q(ee,[["render",se]]),ne={class:"pg-sidebar-nav"},ae={class:"pg-sidebar-heading"},ie={class:"pg-sidebar-items"},oe={class:"item"},re=["href","onClick"],le={class:"text"},ce={__name:"PlaygroundSidebar",props:{examples:{type:Array,required:!0},currentId:{type:String,default:""},open:{type:Boolean,default:!1}},emits:["select","toggle"],setup(e,{emit:t}){const s=t;return(o,n)=>(d(),p(E,null,[l("div",{class:w(["pg-sidebar-backdrop",{open:e.open}]),onClick:n[0]||(n[0]=r=>s("toggle"))},null,2),l("aside",{class:w(["pg-sidebar",{open:e.open}])},[l("nav",ne,[(d(!0),p(E,null,z(e.examples,r=>(d(),p("div",{key:r.category,class:"pg-sidebar-group"},[l("p",ae,$(r.category),1),l("div",ie,[(d(!0),p(E,null,z(r.items,c=>(d(),p("div",{key:c.id,class:w(["pg-sidebar-item",{"is-active":e.currentId===c.id}])},[l("div",oe,[n[1]||(n[1]=l("div",{class:"indicator"},null,-1)),l("a",{class:"link",href:"#"+c.id,onClick:F(m=>s("select",c.id),["prevent"])},[l("p",le,$(c.title),1)],8,re)])],2))),128))])]))),128))])],2)],64))}},de={id:"hello-world",title:"Hello World",js:`import { Elena, html } from "@elenajs/core";
...
<my-stack direction="row">
  ...
  <div>Second</div>
  <div>Third</div>
</my-stack>`},ue={id:"primitive-component",title:"Primitive Component",js:`import { Elena, html } from "@elenajs/core";
...
<my-button variant="danger">Danger</my-button>`},me={id:"declarative-component",title:"Declarative Component",js:`import { Elena } from "@elenajs/core";
...
<my-checkbox disabled label="Disabled"></my-checkbox>`},be={id:"number-props",title:"Number Props",js:`import { Elena, html } from "@elenajs/core";
...
<my-counter count="10" step="5" max="95"></my-counter>`},ye={id:"array-object-props",title:"Array/Object Props",js:`import { Elena, html } from "@elenajs/core";
...
}`,html:"<my-list></my-list>"},we={id:"unsafe-html",title:"unsafeHTML",js:`import { Elena, html, unsafeHTML } from "@elenajs/core";
...
<my-icon name="check" style="color: #48bb78"></my-icon>`},xe={id:"element-ref",title:"Element Ref",js:`import { Elena, html } from "@elenajs/core";
...
<pre id="log"></pre>`},Ee={id:"custom-events",title:"Custom Events",js:`import { Elena, html } from "@elenajs/core";
...
}`,html:"<my-key-logger></my-key-logger>"},_e={id:"will-update",title:"willUpdate",js:`import { Elena, html } from "@elenajs/core";
...
my-filter input:focus {
  outline: 2px solid #5a44d4;
  outline-offset: -1px;
}`,html:"<my-filter></my-filter>"},Me={id:"first-updated",title:"firstUpdated",js:`import { Elena, html } from "@elenajs/core";
...
}`,html:"<my-card></my-card>"},Se={id:"request-update",title:"requestUpdate",js:`import { Elena, html } from "@elenajs/core";
...
<baseline-support featureid="anchor-positioning"></baseline-support>`},Ne={id:"mixins",title:"Mixins",js:`import { Elena, html } from "@elenajs/core";
...
</html>`}function H(e,t){for(const s of e){const o=s.items.find(n=>n.id===t);if(o)return o}return null}function P(){return typeof window>"u"?null:window.location.hash.slice(1)||null}function R(e){typeof window>"u"||history.replaceState(null,"","#"+e)}function Re(e,t){let s;return function(...o){clearTimeout(s),s=setTimeout(()=>e.apply(this,o),t)}}function D(e){const t="https://unpkg.com/@elenajs/core";return e.replace(/from\s+["']@elenajs\/core["']/g,`from "${t}"`).replace(/import\s*\(\s*["']@elenajs\/core["']\s*\)/g,`import("${t}")`)}function De(e,t,s,o){const n=D(t),r=s?`<style>
${s}
</style>
`:"",c=`<!doctype html>
<html lang="en">
...
</html>`,m=(e||"component").toLowerCase().replace(/\s+/g,"-").replace(/[^a-z0-9-]/g,""),f=new Blob([c],{type:"text/html"}),g=URL.createObjectURL(f),b=document.createElement("a");b.href=g,b.download=`elena-${m}.html`,b.click(),URL.revokeObjectURL(g)}function qe(e,{js:t,css:s,html:o}){try{localStorage.setItem(`elena-pg:${e}`,JSON.stringify({js:t,css:s,html:o}))}catch{}}function Ue(e){try{const t=localStorage.getItem(`elena-pg:${e}`);if(!t)return null;const s=JSON.parse(t);return s&&typeof s.js=="string"&&typeof s.html=="string"?{js:s.js,css:s.css||"",html:s.html}:null}catch{return null}}function Fe(e){try{localStorage.removeItem(`elena-pg:${e}`)}catch{}}function We(){try{return localStorage.getItem("elena-pg:autosave")!=="false"}catch{return!0}}function Ve(e){try{localStorage.setItem("elena-pg:autosave",String(e))}catch{}}function Je(e,t,s,o){const n=D(t);return JSON.stringify({title:`Elena | ${e||"Component"}`,html:o||"",css:s||"",js:n||"",js_module:!0,editors:"111"})}const Oe={class:"pg-layout"},Be={key:1,class:"pg-load-error"},Ie={__name:"PlaygroundWrapper",setup(e){const t=G(null),s=h(!1),o=h(!1),n=h(!1),r=h(""),c=h(null),m=h(null),f=h(!1),g=Q(()=>m.value==null?{}:{gridTemplateColumns:`${m.value}px 0px 1fr`});function b(a){a.preventDefault(),f.value=!0,document.addEventListener("pointermove",x),document.addEventListener("pointerup",k)}function x(a){if(!c.value)return;const i=c.value.getBoundingClientRect(),u=320,v=i.width-320;m.value=Math.min(v,Math.max(u,a.clientX-i.left))}function k(){f.value=!1,document.removeEventListener("pointermove",x),document.removeEventListener("pointerup",k)}function _(a){const i=H(y,a);i&&(r.value=i.id,R(i.id),n.value=!1)}function M(){const a=P();a&&a!==r.value&&_(a)}function S(){m.value=null}async function L(){s.value=!1;try{const a=await O(()=>import("./Playground.BjGnVO9E.js"),__vite__mapDeps([0,1]));t.value=a.default}catch{try{const a=await O(()=>import("./Playground.BjGnVO9E.js"),__vite__mapDeps([0,1]));t.value=a.default}catch{s.value=!0}}}return W(async()=>{var v,T,N;window.addEventListener("resize",S);const a=P(),i=((T=(v=y[0])==null?void 0:v.items[0])==null?void 0:T.id)||"primitive-component",u=H(y,a||i)||((N=y[0])==null?void 0:N.items[0]);r.value=(u==null?void 0:u.id)||"",a||R(r.value),window.addEventListener("hashchange",M),await L()}),V(()=>{window.removeEventListener("resize",S),window.removeEventListener("hashchange",M),document.removeEventListener("pointermove",x),document.removeEventListener("pointerup",k)}),(a,i)=>(d(),p("div",Oe,[A(ce,{examples:J(y),"current-id":r.value,open:n.value,onSelect:_,onToggle:i[0]||(i[0]=u=>n.value=!n.value)},null,8,["examples","current-id","open"]),l("div",{ref_key:"mainRef",ref:c,class:w(["pg-main",{"pg-resizing":f.value}]),style:K(g.value)},[(d(),j(Z(t.value||B),{"current-id":r.value,onPreviewReady:i[1]||(i[1]=u=>o.value=!0),onToggleSidebar:i[2]||(i[2]=u=>n.value=!n.value)},null,40,["current-id"])),o.value?(d(),p("div",{key:0,class:"pg-resize-handle",onPointerdown:b},null,32)):C("",!0),A(X,{name:"pg-unload"},{default:Y(()=>[t.value&&!o.value?(d(),j(B,{key:0,class:"pg-loading-overlay"})):C("",!0)]),_:1}),s.value?(d(),p("div",Be,[i[3]||(i[3]=l("p",null,"Failed to load the playground.",-1)),l("button",{onClick:L},"Try again")])):C("",!0)],6)]))}},Ze=Object.freeze(Object.defineProperty({__proto__:null,default:Ie},Symbol.toStringTag,{value:"Module"}));export{Ze as P,De as a,Je as b,Ue as c,Re as d,Fe as e,H as f,Pe as g,y as h,qe as i,We as l,Ve as s};
