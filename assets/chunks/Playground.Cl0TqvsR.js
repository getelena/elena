...
import{o as f,c as b,j as r,n as x,F as C,B as T,t as j,a0 as R,u as F,V as w,q as _,v as A,x as D,G as W,h as V,p as v,E as S,k as Z,ah as Y}from"./framework.lVAEw_NY.js";const J={id:"hello-world",title:"Hello World",js:`import { Elena, html } from "@elenajs/core";
...
MyGreeting.define();`,html:'<my-greeting name="Elena"></my-greeting>'},X={id:"composite-component",title:"Composite Component",js:`import { Elena } from "@elenajs/core";
...
<my-button variant="danger">Danger</my-button>`},G={id:"declarative-component",title:"Declarative Component",js:`import { Elena } from "@elenajs/core";
...
<my-badge variant="error">Error</my-badge>`},ee={id:"boolean-props",title:"Boolean Props",js:`import { Elena, html } from "@elenajs/core";
...
<my-checkbox disabled label="Disabled"></my-checkbox>`},te={id:"number-props",title:"Number Props",js:`import { Elena, html } from "@elenajs/core";
...
<my-counter count="10" step="5" max="95"></my-counter>`},se={id:"array-object-props",title:"Array/Object Props",js:`import { Elena, html } from "@elenajs/core";
...
></my-list>`},ne={id:"conditional-rendering",title:"Conditional Rendering",js:`import { Elena, html, nothing } from "@elenajs/core";
...
<my-alert variant="warning" dismissible>This warning can be dismissed.</my-alert>`},ae={id:"list-rendering",title:"List Rendering",js:`import { Elena, html } from "@elenajs/core";
...
}`,html:"<my-list></my-list>"},ie={id:"unsafe-html",title:"unsafeHTML",js:`import { Elena, html, unsafeHTML } from "@elenajs/core";
...
<my-icon name="check" style="color: #48bb78"></my-icon>`},re={id:"element-ref",title:"Element Ref",js:`import { Elena, html } from "@elenajs/core";
...
<pre id="log"></pre>`},le={id:"custom-events",title:"Custom Events",js:`import { Elena, html } from "@elenajs/core";
...
<p id="output">Click a star to rate.</p>`},ce={id:"manual-listeners",title:"Manual Listeners",js:`import { Elena, html } from "@elenajs/core";
...
}`,html:"<my-key-logger></my-key-logger>"},de={id:"will-update",title:"willUpdate",js:`import { Elena, html } from "@elenajs/core";
...
my-filter input:focus {
  outline: 2px solid #5a44d4;
  outline-offset: -1px;
}`,html:"<my-filter></my-filter>"},pe={id:"first-updated",title:"firstUpdated",js:`import { Elena, html } from "@elenajs/core";
...
<my-button class="brand-theme">Brand Theme</my-button>`},he={id:"baseline-support",title:"Baseline Support",js:`/** 
...
<baseline-support featureid="anchor-positioning"></baseline-support>`},fe={id:"mixins",title:"Mixins",js:`import { Elena, html } from "@elenajs/core";
...
</div>`},be={id:"shadow-dom",title:"Shadow DOM",js:`import { Elena, html } from "@elenajs/core";
...
</html>`}function ke(o,a){for(const e of o){const t=e.items.find(l=>l.id===a);if(t)return t}return null}function O(){return typeof window>"u"?null:window.location.hash.slice(1)||null}function Ee(o){typeof window>"u"||history.replaceState(null,"","#"+o)}function Ce(o,a){let e;return function(...t){clearTimeout(e),e=setTimeout(()=>o.apply(this,t),a)}}const _e={class:"pg-sidebar-nav"},Me={class:"pg-sidebar-heading"},Se={class:"pg-sidebar-items"},Le={class:"item"},Te=["href","onClick"],je={class:"text"},Ae={__name:"PlaygroundSidebar",props:{examples:{type:Array,required:!0},currentId:{type:String,default:""},open:{type:Boolean,default:!1}},emits:["select","toggle"],setup(o,{emit:a}){const e=a;return(t,l)=>(f(),b(C,null,[r("div",{class:x(["pg-sidebar-backdrop",{open:o.open}]),onClick:l[0]||(l[0]=c=>e("toggle"))},null,2),r("aside",{class:x(["pg-sidebar",{open:o.open}])},[r("nav",_e,[(f(!0),b(C,null,T(o.examples,c=>(f(),b("div",{key:c.category,class:"pg-sidebar-group"},[r("p",Me,j(c.category),1),r("div",Se,[(f(!0),b(C,null,T(c.items,s=>(f(),b("div",{key:s.id,class:x(["pg-sidebar-item",{"is-active":o.currentId===s.id}])},[r("div",Le,[l[1]||(l[1]=r("div",{class:"indicator"},null,-1)),r("a",{class:"link",href:"#"+s.id,onClick:R(y=>e("select",s.id),["prevent"])},[r("p",je,j(s.title),1)],8,Te)])],2))),128))])]))),128))])],2)],64))}},Ne={class:"pg-editor"},ze={class:"pg-editor-tabs"},$e=["onClick"],Be={__name:"PlaygroundEditor",props:{js:{type:String,default:""},css:{type:String,default:""},html:{type:String,default:""},activeTab:{type:String,default:"js"}},emits:["update:js","update:css","update:html","update:activeTab","toggle-sidebar"],setup(o,{emit:a}){const e=o,t=a,{isDark:l}=F(),c=v(null),s=W(null),y=V(()=>e.css?["js","css","html"]:["js","html"]),p=typeof window<"u"?Promise.all([w(()=>import("./index.D4PcRLKH.js"),__vite__mapDeps([0,1,2,3])),w(()=>import("./index.tqIctuLa.js"),[]),w(()=>import("./index.KpVkJyBP.js"),__vite__mapDeps([4,5,1,2,3])),w(()=>import("./index.BHg0SI1Q.js"),__vite__mapDeps([6,5,1,2,7,4,3])),w(()=>import("./index.iNtltN6x.js"),__vite__mapDeps([7,5,1,2])),w(()=>import("./index.DRciRTh7.js"),__vite__mapDeps([8,1,2]))]):null;let d=null,h=null,n=null;function m(i){return i==="js"?e.js:i==="css"?e.css:e.html}function H(i){return i==="js"?"update:js":i==="css"?"update:css":"update:html"}async function P(){if(d)return d;const[i,u,g,k,E,M]=await p;return d={cm:i,cmState:u,langJs:g,langHtml:k,langCss:E,themeDark:M},d}function N(i){return d?i==="js"?d.langJs.javascript():i==="css"?d.langCss.css():d.langHtml.html():[]}function z(){return d?l.value?d.themeDark.oneDark:[]:[]}async function I(){const i=await P(),{EditorView:u,basicSetup:g}=i.cm,{EditorState:k,Compartment:E}=i.cmState;h=new E,n=new E;const M=m(e.activeTab),U=k.create({doc:M,extensions:[g,h.of(N(e.activeTab)),n.of(z()),u.updateListener.of(B=>{B.docChanged&&t(H(e.activeTab),B.state.doc.toString())}),u.theme({"&":{height:"100%",fontSize:"13px"},".cm-scroller":{overflow:"auto",fontFamily:"ui-monospace, monospace"},".cm-content":{padding:"12px 0"},".cm-gutters":{border:"none"}})]});s.value&&s.value.destroy(),s.value=new u({state:U,parent:c.value})}function q(i){i!==e.activeTab&&t("update:activeTab",i)}function $(){if(!s.value)return;const i=m(e.activeTab),u=s.value.state.doc.toString();i!==u&&s.value.dispatch({changes:{from:0,to:s.value.state.doc.length,insert:i}})}return _(()=>e.activeTab,()=>{!s.value||!d||($(),s.value.dispatch({effects:h.reconfigure(N(e.activeTab))}))}),_([()=>e.js,()=>e.css,()=>e.html],$),_(l,()=>{!s.value||!n||s.value.dispatch({effects:n.reconfigure(z())})}),A(I),D(()=>{s.value&&s.value.destroy()}),(i,u)=>(f(),b("div",Ne,[r("div",ze,[r("button",{class:"pg-sidebar-toggle",onClick:u[0]||(u[0]=g=>t("toggle-sidebar")),"aria-label":"Toggle examples"},[...u[1]||(u[1]=[r("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none"},[r("path",{d:"M2 4h12M2 8h12M2 12h12",stroke:"currentColor","stroke-width":"1.5","stroke-linecap":"round"})],-1)])]),(f(!0),b(C,null,T(y.value,g=>(f(),b("button",{key:g,class:x(["pg-editor-tab",{active:o.activeTab===g}]),onClick:k=>q(g)},j(g.toUpperCase()),11,$e))),128))]),r("div",{ref_key:"editorContainer",ref:c,class:"pg-editor-container"},null,512)]))}},Oe={class:"pg-preview"},De=["srcdoc"],He={__name:"PlaygroundPreview",props:{js:{type:String,default:""},css:{type:String,default:""},html:{type:String,default:""}},setup(o){const a=o,e=v(null),t=v(null),l=v(!1);function c(){l.value=!1,t.value=xe(a.js,a.css,a.html)}const s=Ce(c,300);return A(c),_([()=>a.js,()=>a.css,()=>a.html],(y,p)=>{p&&y[0]!==p[0]&&y[1]!==p[1]&&y[2]!==p[2]?c():s()}),(y,p)=>(f(),b("div",Oe,[r("div",{class:"pg-preview-header"},[p[1]||(p[1]=r("span",{class:"pg-preview-title"},"Preview",-1)),r("button",{class:"pg-preview-reload",onClick:c,title:"Reload preview"},[...p[0]||(p[0]=[r("svg",{width:"14",height:"14",viewBox:"0 0 16 16",fill:"none"},[r("path",{d:"M13.65 2.35A7.96 7.96 0 0 0 8 0C3.58 0 0 3.58 0 8s3.58 8 8 8c3.73 0 6.84-2.55 7.73-6h-2.08A5.99 5.99 0 0 1 8 14 6 6 0 1 1 8 2c1.66 0 3.14.69 4.22 1.78L9 7h7V0l-2.35 2.35z",fill:"currentColor"})],-1)])])]),r("iframe",{ref_key:"iframe",ref:e,class:x(["pg-preview-iframe",{"pg-preview-ready":l.value}]),srcdoc:t.value,sandbox:"allow-scripts allow-same-origin",title:"Component preview"},null,10,De)]))}},Pe={class:"pg-layout"},qe={__name:"Playground",setup(o){var p,d;const a=v(!1),e=v("js"),t=Y({js:"",css:"",html:""}),l=v("");function c(h){const n=ke(L,h);n&&(l.value=n.id,t.js=n.js,t.css=n.css,t.html=n.html,e.value="js",Ee(n.id),a.value=!1)}function s(){const h=O();h&&h!==l.value&&c(h)}const y=((d=(p=L[0])==null?void 0:p.items[0])==null?void 0:d.id)||"hello-world";return A(()=>{c(O()||y),window.addEventListener("hashchange",s)}),D(()=>{window.removeEventListener("hashchange",s)}),(h,n)=>(f(),b("div",Pe,[S(Ae,{examples:Z(L),"current-id":l.value,open:a.value,onSelect:c,onToggle:n[0]||(n[0]=m=>a.value=!a.value)},null,8,["examples","current-id","open"]),S(Be,{js:t.js,css:t.css,html:t.html,"active-tab":e.value,"onUpdate:js":n[1]||(n[1]=m=>t.js=m),"onUpdate:css":n[2]||(n[2]=m=>t.css=m),"onUpdate:html":n[3]||(n[3]=m=>t.html=m),"onUpdate:activeTab":n[4]||(n[4]=m=>e.value=m),onToggleSidebar:n[5]||(n[5]=m=>a.value=!a.value)},null,8,["js","css","html","active-tab"]),S(He,{js:t.js,css:t.css,html:t.html},null,8,["js","css","html"])]))}};export{qe as default};
