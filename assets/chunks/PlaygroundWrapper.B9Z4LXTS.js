const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/Playground.BsG70xu2.js","assets/chunks/framework.CeoCFqMR.js"])))=>i.map(i=>d[i]);
import{_ as q,o as d,c as p,ae as U,j as l,n as x,F as C,z,t as N,Z as F,v as W,x as J,C as j,k as V,b as B,E as Z,e as _,w as K,T as Y,L as G,p as h,S as A,D as X,h as Q}from"./framework.CeoCFqMR.js";const ee={},te={class:"pg-loading-skeleton"};function se(e,t){return d(),p("div",te,[...t[0]||(t[0]=[U('<div class="pg-editor pg-editor-loading"><div class="pg-editor-tabs"><button class="pg-editor-tab active">HTML</button><button class="pg-editor-tab">CSS</button><button class="pg-editor-tab">JS</button></div><div class="pg-editor-container"></div></div><div class="pg-preview"><div class="pg-preview-header"><span class="pg-preview-title">Preview</span></div><div class="pg-preview-iframe"></div></div>',2)])])}const I=q(ee,[["render",se]]),ne={class:"pg-sidebar-nav"},ie={class:"pg-sidebar-heading"},ae={class:"pg-sidebar-items"},oe={class:"item"},re=["href","onClick"],le={class:"text"},ce={__name:"PlaygroundSidebar",props:{examples:{type:Array,required:!0},currentId:{type:String,default:""},open:{type:Boolean,default:!1}},emits:["select","toggle"],setup(e,{emit:t}){const s=t;return(o,n)=>(d(),p(C,null,[l("div",{class:x(["pg-sidebar-backdrop",{open:e.open}]),onClick:n[0]||(n[0]=r=>s("toggle"))},null,2),l("aside",{class:x(["pg-sidebar",{open:e.open}])},[l("nav",ne,[(d(!0),p(C,null,z(e.examples,r=>(d(),p("div",{key:r.category,class:"pg-sidebar-group"},[l("p",ie,N(r.category),1),l("div",ae,[(d(!0),p(C,null,z(r.items,c=>(d(),p("div",{key:c.id,class:x(["pg-sidebar-item",{"is-active":e.currentId===c.id}])},[l("div",oe,[n[1]||(n[1]=l("div",{class:"indicator"},null,-1)),l("a",{class:"link",href:"#"+c.id,onClick:F(u=>s("select",c.id),["prevent"])},[l("p",le,N(c.title),1)],8,re)])],2))),128))])]))),128))])],2)],64))}},de={id:"hello-world",title:"Hello World",js:`import { Elena, html } from "@elenajs/core";
...
</p>`},b=[{category:"Basics",items:[me,pe,ue,de]},{category:"Props",items:[he,fe,ye,be]},{category:"Templates",items:[ge,ve,xe,we]},{category:"Events",items:[ke,Ce,_e]},{category:"Lifecycle",items:[Ee,Se,Me]},{category:"Styling",items:[Le]},{category:"Advanced",items:[$e,ze,Te]}],Ne=`/**
...
`,O=Ne.replace(/\/\/# sourceMappingURL=.*$/m,"").trim(),je=typeof Blob<"u"?URL.createObjectURL(new Blob([O],{type:"text/javascript"})):`data:text/javascript;charset=utf-8,${encodeURIComponent(O)}`,Be=JSON.stringify({imports:{"@elenajs/core":je}});function He(e,t,s){return`<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
</html>`,u=(e||"component").toLowerCase().replace(/\s+/g,"-").replace(/[^a-z0-9-]/g,""),f=new Blob([c],{type:"text/html"}),g=URL.createObjectURL(f),y=document.createElement("a");y.href=g,y.download=`elena-${u}.html`,y.click(),URL.revokeObjectURL(g)}function qe(e,{js:t,css:s,html:o}){try{localStorage.setItem(`elena-pg:${e}`,JSON.stringify({js:t,css:s,html:o}))}catch{}}function Ue(e){try{const t=localStorage.getItem(`elena-pg:${e}`);if(!t)return null;const s=JSON.parse(t);return s&&typeof s.js=="string"&&typeof s.html=="string"?{js:s.js,css:s.css||"",html:s.html}:null}catch{return null}}function Fe(e){try{localStorage.removeItem(`elena-pg:${e}`)}catch{}}function We(e,t,s,o){const n=D(t);return JSON.stringify({title:`Elena | ${e||"Component"}`,html:o||"",css:s||"",js:n||"",js_module:!0,editors:"111"})}const Ae={class:"pg-layout"},Ie={key:1,class:"pg-load-error"},Oe={__name:"PlaygroundWrapper",setup(e){const t=X(null),s=h(!1),o=h(!1),n=h(!1),r=h(""),c=h(null),u=h(null),f=h(!1),g=Q(()=>u.value==null?{}:{gridTemplateColumns:`${u.value}px 0px 1fr`});function y(i){i.preventDefault(),f.value=!0,document.addEventListener("pointermove",w),document.addEventListener("pointerup",k)}function w(i){if(!c.value)return;const a=c.value.getBoundingClientRect(),m=320,v=a.width-320;u.value=Math.min(v,Math.max(m,i.clientX-a.left))}function k(){f.value=!1,document.removeEventListener("pointermove",w),document.removeEventListener("pointerup",k)}function E(i){const a=P(b,i);a&&(r.value=a.id,R(a.id),n.value=!1)}function S(){const i=H();i&&i!==r.value&&E(i)}function M(){u.value=null}async function L(){s.value=!1;try{const i=await A(()=>import("./Playground.BsG70xu2.js"),__vite__mapDeps([0,1]));t.value=i.default}catch{try{const i=await A(()=>import("./Playground.BsG70xu2.js"),__vite__mapDeps([0,1]));t.value=i.default}catch{s.value=!0}}}return W(async()=>{var v,T,$;window.addEventListener("resize",M);const i=H(),a=((T=(v=b[0])==null?void 0:v.items[0])==null?void 0:T.id)||"primitive-component",m=P(b,i||a)||(($=b[0])==null?void 0:$.items[0]);r.value=(m==null?void 0:m.id)||"",i||R(r.value),window.addEventListener("hashchange",S),await L()}),J(()=>{window.removeEventListener("resize",M),window.removeEventListener("hashchange",S),document.removeEventListener("pointermove",w),document.removeEventListener("pointerup",k)}),(i,a)=>(d(),p("div",Ae,[j(ce,{examples:V(b),"current-id":r.value,open:n.value,onSelect:E,onToggle:a[0]||(a[0]=m=>n.value=!n.value)},null,8,["examples","current-id","open"]),l("div",{ref_key:"mainRef",ref:c,class:x(["pg-main",{"pg-resizing":f.value}]),style:G(g.value)},[(d(),B(Z(t.value||I),{"current-id":r.value,onPreviewReady:a[1]||(a[1]=m=>o.value=!0),onToggleSidebar:a[2]||(a[2]=m=>n.value=!n.value)},null,40,["current-id"])),o.value?(d(),p("div",{key:0,class:"pg-resize-handle",onPointerdown:y},null,32)):_("",!0),j(Y,{name:"pg-unload"},{default:K(()=>[t.value&&!o.value?(d(),B(I,{key:0,class:"pg-loading-overlay"})):_("",!0)]),_:1}),s.value?(d(),p("div",Ie,[a[3]||(a[3]=l("p",null,"Failed to load the playground.",-1)),l("button",{onClick:L},"Try again")])):_("",!0)],6)]))}},Je=Object.freeze(Object.defineProperty({__proto__:null,default:Oe},Symbol.toStringTag,{value:"Module"}));export{Je as P,De as a,We as b,Fe as c,Re as d,b as e,P as f,He as g,Ue as l,qe as s};
